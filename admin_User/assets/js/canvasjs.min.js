/*
 CanvasJS.php5 & JavaScript Charts - v3.7.1 GA - https://canvasjs.com/ 
...
(function() {
    ...
    function Wa(h, m, F) {
        "millisecond" === F ? h.setMilliseconds(h.getMilliseconds() + 1 * m) : "second" === F ? h.setSeconds(h.getSeconds() + 1 * m) : "minute" === F ? h.setMinutes(h.getMinutes() + 1 * m) : "hour" === F ? h.setHours(h.getHours() + 1 * m) : "day" === F ? h.setDate(h.getDate() + 1 * m) : "week" === F ? h.setDate(h.getDate() + 7 * m) : "month" === F ? h.setMonth(h.getMonth() + 1 * m) : "year" === F && h.setFullYear(h.getFullYear() +
            1 * m);
        return h
    }
    ...
    function Ga(h) {
        if (!h) return h;
        h = h.replace(/^\s\s*/, "");
        for (var m = /\s/, F = h.length; m.test(h.charAt(--F)););
        return h.slice(0, F + 1)
    }

    function Ca(h) {
        h.roundRect = function(h, F, r, v, sa, E, w, A) {
            w && (this.fillStyle = w);
            ...
            this.beginPath();
            this.moveTo(h + sa, F);
            this.lineTo(h + r - sa, F);
            this.quadraticCurveTo(h + r, F, h + r, F + sa);
            this.lineTo(h +
                r, F + v - sa);
            this.quadraticCurveTo(h + r, F + v, h + r - sa, F + v);
            this.lineTo(h + sa, F + v);
            this.quadraticCurveTo(h, F + v, h, F + v - sa);
            this.lineTo(h, F + sa);
            this.quadraticCurveTo(h, F, h + sa, F);
            this.closePath();
            w && this.fill();
            A && 0 < E && this.stroke()
        }
    ...
    function fb(h) {
        if (U.fSDec) h[ja("`eeDwdouMhrudods")](ja("e`u`@ohl`uhnoHuds`uhnoDoe"), function() {
            U._fTWm && U._fTWm(h)
        })
    }
    ...
    function I(h, m) {
        ...
        if (F = {
            ...
            for (var r = 0; r < F.length; r++) F[r] *= m;
        else F = [];
        return F
    }

    function J(h, m, F, v, Y) {
        v = v || [];
        Y = r(Y) ? gb ? {
            passive: !1,
            capture: !1
        ...
        v.push([h, m, F, Y]);
        return h.addEventListener ? (h.addEventListener(m, F, Y), F) : h.attachEvent ? (v = function(m) {
            m = m || window.event;
    ...
    function hb(h) {
        if (h._menuButton) h.exportEnabled ?
            ...
            }), La(h._menuButton), h._menuButton.title = h._cultureInfo.menuText) : wa(h._menuButton);
        else if (h.exportEnabled && v) {
            var m = !1;
            ...
            J(h._menuButton, "mousemove", function() {
                m || (V(h._menuButton, {
        ...
        if (h.exportEnabled && h._dropdownMenu) {
            ...
            for (var F = h._dropdownMenu.childNodes, r = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], Y = 0; Y < F.length; Y++) V(F[Y], {
                    backgroundColor: h.toolbar.itemBackgroundColor,
                    color: h.toolbar.fontColor
                }),
                F[Y].inne.php = r[Y]
        } else !h._dropdownMenu && (h.exportEnabled && v) && (m = !1, h._dropdownMenu = document.createElement("div"), h._dropdownMenu.setAttribute("tabindex", -1), F = -1 !== h.theme.indexOf("dark") ? "black" : "#888888", V(h._dropdownMenu, {
                position: "absolute",
                zIndex: 1,
                userSelect: "none",
                MozUserSeelct: "none",
            ...
            }, h.allDOMEventHandlers, !0), F = document.createElement("div"), V(F, {
                padding: "12px 8px 12px 8px"
            }), F.inne.php = h._cultureInfo.printText, F.style.backgroundColor = h.toolbar.itemBackgroundColor, F.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(F),
            J(F, "touchstart", function(h) {
                m = !0
            }, h.allDOMEventHandlers), J(F, "mousemove", function() {
                m || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover)
            }, h.allDOMEventHandlers, !0), J(F, "mouseout", function() {
                m || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor)
            }, h.allDOMEventHandlers, !0), J(F, "click", function() {
                h.print();
                wa(h._dropdownMenu)
            }, h.allDOMEventHandlers, !0), F = document.createElement("div"), V(F, {
                padding: "12px 8px 12px 8px"
            }),
            F.inne.php = h._cultureInfo.saveJPGText, F.style.backgroundColor = h.toolbar.itemBackgroundColor, F.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(F), J(F, "touchstart", function(h) {
                m = !0
            }, h.allDOMEventHandlers), J(F, "mousemove", function() {
                m || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover)
            }, h.allDOMEventHandlers, !0), J(F, "mouseout", function() {
                ...
                padding: "12px 8px 12px 8px"
            }), F.inne.php = h._cultureInfo.savePNGText, F.style.backgroundColor = h.toolbar.itemBackgroundColor, F.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(F), J(F, "touchstart", function(h) {
                m = !0
            }, h.allDOMEventHandlers), J(F, "mousemove", function() {
    ...
    function Za(h, m, F) {
        h *= la;
        m *= la;
        h = F.getImageData(h, m, 2, 2).data;
        m = !0;
        for (F = 0; 4 > F; F++)
            if (h[F] !== h[F + 4] | h[F] !== h[F + 8] | h[F] !== h[F + 12]) {
                m = !1;
                break
            }
        return m ?
    ...
    function Ma(h, m, F) {
        if (v && $a) {
            ...
            h.width = m * la;
            h.height = F * la;
            Ra !== Na && (h.style.width = m + "px", h.style.height = F + "px", r.scale(la, la))
        } else h.width = m, h.height = F
    }
    ...
    function ib(h) {
        if (!jb) {
            var m = !1,
                r = !1;
            "undefined" === typeof ra.Chart.creditHref ? (h.creditHref = ja("iuuqr;..b`ow`rkr/bnl."),
                h.creditText = ja("B`ow`rKR/bnl")) : (m = h.updateOption("creditText"), r = h.updateOption("creditHref"));
            if (h.creditHref && h.creditText) {
                h._creditLink || (h._creditLink = document.createElement("a"), h._creditLink.setAttribute("class", "canvasjs-chart-credit"), h._creditLink.setAttribute("title", "JavaScript Charts"), V(h._creditLink, {
                        outline: "none",
                        margin: "0px",
                        position: "absolute",
                        right: "2px",
                ...
                if (0 === h.renderCount || m || r) h._creditLink.setAttribute("href", h.creditHref), h._creditLink.inne.php = h.creditText;
    ...
    function va(h, m) {
        ...
        Ma(r, h, m);
        v || "undefined" === typeof G_vmlCanvasManager || G_vmlCanvasManager.initElement(r);
        return r
    }

    function V(h, m) {
        for (var r in m) h.style[r] = m[r]
    }

    function xa(h, m, r) {
        m.getAttribute("state") || (m.style.backgroundColor = h.toolbar.itemBackgroundColor, m.style.color = h.toolbar.fontColor, m.style.border = "none", V(m, {
            WebkitUserSelect: "none",
            MozUserSelect: "none",
            msUserSelect: "none",
            userSelect: "none"
        ...
        m.getAttribute("state") !==
            r && (m.setAttribute("state", r), m.setAttribute("type", "button"), V(m, {
                padding: "5px 12px",
                cursor: "pointer",
                "float": "left",
                width: "40px",
                ...
                lineHeight: "0"
            }), m.setAttribute("title", h._cultureInfo[r + "Text"]), m.inne.php = "<img src='" + kb[r].image + "' alt='" + h._cultureInfo[r + "Text"] + "' />", V(m.childNodes[0], {
                height: "95%",
                pointerEvents: "none"
            }))
    }
    ...
    function W(h, m, F, v, Y) {
        ...
        h = {};
        this.theme && r(this.parent) && r(m) && r(v) ? h = r(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[m]) && (null === v ? h = this.parent.themeOptions[m] : 0 < this.parent.themeOptions[m].length && (v = Math.min(this.parent.themeOptions[m].length - 1, v), h = this.parent.themeOptions[m][v]));
        this.themeOptions = h;
        this.options = F ? F : {
            _isPlaceholder: !0
        };
    ...
    function Ta(h, m) {
        Ta.base.constructor.call(this, "Toolbar", "toolbar", m, null, h);
        this.chart = h;
    ...
    function za(h, m) {
        ...
        if (r(this.options.margin) && h.options.subtitles)
            for (var F = h.options.subtitles, v = 0; v < F.length; v++)
                if ((r(F[v].horizontalAlign) && "center" === this.horizontalAlign || F[v].horizontalAlign === this.horizontalAlign) && (r(F[v].verticalAlign) && "top" === this.verticalAlign || F[v].verticalAlign === this.verticalAlign) && !F[v].dockInsidePlotArea === !this.dockInsidePlotArea) {
                    this.margin = 0;
                    break
                }
    ...
    var Ha = !1,
        ...
        w = v ? "Trebuchet MS, Helvetica, sans-serif" : "Arial",
    ...
    (function() {
        U.fSDec = function(h) {
            for (var m = "", r = 0; r < h.length; r++) m += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(r));
            return m
        };
        ...
        U._fTWm = function(h) {
            if ("undefined" === typeof U.pro.sCH && !cb) try {
                var m = (new Date).getMonth() % 3,
                    r, v, Y = h[U.fSDec("buy")];
                Y[U.fSDec("udyuC`rdmhod")] = U.fSDec("unq");
                Y[U.fSDec("gnou")] = 11 + U.fSDec("qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg");
                Y[U.fSDec("ghmmRuxmd")] = U.fSDec("fsdx");
                r = "cm" === U.pos[m] || "um" === U.pos[m] ? 0 : h.width - Y[U.fSDec("ld`rtsdUdyu")](U.fSDec("B`ow`rKR!Ush`m")).width;
                v = "um" === U.pos[m] ? 0 : h.height - 11;
                Y[U.fSDec("ghmmUdyu")](U.fSDec("B`ow`rKR!Ush`m"), r, v);
                "cs" ===
                U.pos[m] && (h[U.fSDec("^bsdehuMhoj")].style.right = U.fSDec("`tun"))
            } catch (w) {}
        }
    })();
    var gb = function() {
        ...
        Ba = function() {
            ...
            return function(A, I, Q) {
                ...
                "UTC:" === I.slice(0, 4) && (I = I.slice(4), U = !0);
                Q = U ? "getUTC" : "get";
                var V = A[Q + "Date"](),
                    N = A[Q + "Day"](),
                    ba = A[Q + "Month"](),
                    ...
                    b = A[Q + "Seconds"](),
                    e = A[Q + "Milliseconds"](),
                    f = U ? 0 : A.getTimezoneOffset();
                return Q = I.replace(h, function(l) {
                    switch (l) {
                        case "D":
                            return V;
                        case "DD":
                        ...
                        case "TT":
                            return 12 > d ? "AM" : "PM";
                        case "K":
                            return U ? "UTC" : (String(A).match(w) || [""]).pop().replace(E, "");
                        case "z":
        ...
        ha = function(h, m, r) {
            ...
            for (var N = 0; A && N < A.length; N++)
                if (m = A[N], "." === m && 0 > I) I = N;
                    ...
                    if ("%" === m) E *= 100;
                        ...
                        E /= Math.pow(1E3, m.length - 1);
                        I = N + m.length - 1;
                        continue
                    } else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || (U = !0);
                    0 > I ? (Q.push(m), "#" === m || "0" === m ? O++ : "," === m && K++) : (P.push(m), "#" !== m && "0" !== m || J++)
                }
            U && (m = Math.floor(h), A = -Math.floor(Math.log(h) / Math.LN10 + 1), V = 0 === h ? 0 : 0 === m ? -(O +
                A) : String(m).length - O, E /= Math.pow(10, V));
            0 > I && (I = N);
            E = (h * E).toFixed(J);
            m = E.split(".");
            E = (m[0] + "").split("");
            h = (m[1] + "").split("");
            E && "0" === E[0] && E.shift();
            for (U = A = N = J = I = 0; 0 < Q.length;)
                if (m = Q.pop(), "#" === m || "0" === m)
                    if (I++, I === O) {
                        var ba = E,
                            E = [];
                        if ("0" === m)
                            for (m = O - J - (ba ? ba.length : 0); 0 < m;) ba.unshift("0"), m--;
                        for (; 0 < ba.length;) r = ba.pop() + r, U++, 0 === U % A && (N === K && 0 < ba.length) && (r = w + r)
                    } else 0 < E.length ? (r = E.pop() + r, J++, U++) : "0" === m && (r = "0" + r, J++, U++), 0 === U % A && (N === K && 0 < E.length) && (r = w + r);
            else "E" !== m[0] && "e" !==
                m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (N++, A = U, U = 0, 0 < E.length && (r = w + r)) : r = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + r : m + r : (m = 0 > V ? m.replace("+", "").replace("-", "") : m.replace("-", ""), r += m.replace(/[0]+/, function(a) {
                    return ca(V, a.length)
                }));
            w = "";
            for (Q = !1; 0 < P.length;) m = P.shift(), "#" === m || "0" === m ? 0 < h.length && 0 !== Number(h.join("")) ? (w += h.shift(), Q = !0) : "0" === m && (w += "0", Q = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" ===
                m[0] && "'" === m[m.length - 1]) ? w += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? w += m : (m = 0 > V ? m.replace("+", "").replace("-", "") : m.replace("-", ""), w += m.replace(/[0]+/, function(a) {
                return ca(V, a.length)
            }));
            r += (Q ? Y : "") + w;
            return v ? "-" + r : r
        ...
        Na = 1,
        la = $a ? Ra / Na : 1,
        da = function(h, m, r, v, w, A, E, I, O, Q, U, P, J) {
            "undefined" === typeof J && (J = 1);
            E = E || 0;
            I = I || "black";
            var K = 15 < v - m && 15 < w - r ? 8 : 0.35 * Math.min(v - m, w - r);
            h.beginPath();
            h.moveTo(m, r);
            h.save();
            h.fillStyle = A;
            h.globalAlpha = J;
            h.fillRect(m, r, v - m, w - r);
            h.globalAlpha = 1;
            0 < E && (J = 0 === E % 2 ? 0 : 0.5, h.beginPath(), h.lineWidth = E, h.strokeStyle = I, h.moveTo(m, r), h.rect(m - J, r - J, v - m + 2 * J, w - r + 2 * J), h.stroke());
            h.restore();
            !0 === O && (h.save(), h.beginPath(), h.moveTo(m, r), h.lineTo(m + K, r + K), h.lineTo(v -
                K, r + K), h.lineTo(v, r), h.closePath(), E = h.createLinearGradient((v + m) / 2, r + K, (v + m) / 2, r), E.addColorStop(0, A), E.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = E, h.fill(), h.restore());
            !0 === Q && (h.save(), h.beginPath(), h.moveTo(m, w), h.lineTo(m + K, w - K), h.lineTo(v - K, w - K), h.lineTo(v, w), h.closePath(), E = h.createLinearGradient((v + m) / 2, w - K, (v + m) / 2, w), E.addColorStop(0, A), E.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = E, h.fill(), h.restore());
            !0 === U && (h.save(), h.beginPath(), h.moveTo(m, r), h.lineTo(m + K, r +
                K), h.lineTo(m + K, w - K), h.lineTo(m, w), h.closePath(), E = h.createLinearGradient(m + K, (w + r) / 2, m, (w + r) / 2), E.addColorStop(0, A), E.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = E, h.fill(), h.restore());
            !0 === P && (h.save(), h.beginPath(), h.moveTo(v, r), h.lineTo(v - K, r + K), h.lineTo(v - K, w - K), h.lineTo(v, w), E = h.createLinearGradient(v - K, (w + r) / 2, v, (w + r) / 2), E.addColorStop(0, A), E.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = E, E.addColorStop(0, A), E.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = E, h.fill(),
        ...
        cb = window && window[ja("mnb`uhno")] && window[ja("mnb`uhno")].href && window[ja("mnb`uhno")].href.indexOf && (-1 !== window[ja("mnb`uhno")].href.indexOf(ja("b`ow`rkr/bnl")) || -1 !== window[ja("mnb`uhno")].href.indexOf(ja("gdonqhy/bnl")) || -1 !== window[ja("mnb`uhno")].href.indexOf(ja("gheemd"))),
    ...
    W.prototype.setOptions = function(h, m) {
        if (ra[this._defaultsKey]) {
            var r = ra[this._defaultsKey],
                v;
            for (v in r) "publicProperties" !== v && r.hasOwnProperty(v) && (this[v] = h && v in h ? h[v] : m && v in m ? m[v] : r[v])
    ...
    W.prototype.set = function(h, m, r) {
        r = "undefined" === typeof r ? !0 : r;
        var v = ra[this._defaultsKey];
        if ("options" === h) this.createUserOptions(m);
        else if (v.hasOwnProperty(h) || v.publicProperties && v.publicProperties.hasOwnProperty(h) && "readWrite" === v.publicProperties[h]) this.options._isPlaceholder && this.createUserOptions(), this.options[h] = m;
        else {
    ...
    W.prototype.updateOption = function(h) {
        ...
        var m = ra[this._defaultsKey],
            ...
            I = this._index;
        this.theme && r(this.parent) && r(A) && r(I) ? v = r(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[A]) && (null === I ? v = this.parent.themeOptions[A] : 0 < this.parent.themeOptions[A].length && (v = Math.min(this.parent.themeOptions[A].length - 1, I), v = this.parent.themeOptions[A][v]));
        this.themeOptions = v;
        h in m && (w = h in this.options ? this.options[h] : v && h in v ? v[h] : m[h]);
        if (w === this[h]) return !1;
        this[h] =
            w;
        return !0
    };
    W.prototype.trackChanges = function(h) {
        if (!this.sessionVariables) throw "Session Variable Store not set";
        this.sessionVariables[h] = this.options[h]
    };
    W.prototype.isBeingTracked = function(h) {
        this.options._oldOptions || (this.options._oldOptions = {});
        return this.options._oldOptions[h] ? !0 : !1
    };
    W.prototype.hasOptionChanged = function(h) {
        if (!this.sessionVariables) throw "Session Variable Store not set";
        return this.sessionVariables[h] !== this.options[h]
    };
    W.prototype.addEventListener = function(h, m, r) {
    ...
    W.prototype.removeEventListener = function(h, m) {
        if (h && m && this._eventListeners[h])
            for (var r = this._eventListeners[h], v = 0; v < r.length; v++)
                if (r[v].eventHandler === m) {
                    r[v].splice(v, 1);
                    break
                }
    };
    W.prototype.removeAllEventListeners = function() {
        this._eventListeners = []
    };
    W.prototype.dispatchEvent = function(h, m, r) {
        if (h && this._eventListeners[h]) {
            m = m || {};
            for (var v = this._eventListeners[h], w = 0; w < v.length; w++) v[w].eventHandler.call(v[w].context,
                m)
        }
    ...
    Ea.prototype.unRegisterSpace = function(h, m) {
        "top" === h ? this._topOccupied -= m.height : "bottom" === h ? this._bottomOccupied -= m.height : "left" === h ? this._leftOccupied -= m.width : "right" === h && (this._rightOccupied -= m.width)
    };
    ...
    ka.prototype.render = function(h) {
        if (0 !== this.fontSize) {
            ...
            for (r = 0; r < this._wrappedText.lines.length; r++) {
                ...
                if ("right" === this.horizontalAlign || "right" === this.textAlign) v = this.width - A.width - this.rightPadding;
                else if ("left" === this.horizontalAlign || "left" === this.textAlign) v = this.leftPadding;
                else if ("center" === this.horizontalAlign || "center" === this.textAlign) v = (this.width - (this.leftPadding + this.rightPadding)) / 2 - A.width / 2 + this.leftPadding;
                this.ctx.fillText(A.text, v, w);
                w += A.height
            }
            this.ctx.font = m;
            h && this.ctx.restore()
    ...
    ka.prototype._getLineWithWidth = function(h, m, r) {
        ...
        r > m && 1 < E.length && (E = E.substr(0, E.length - 1), r = this.ctx.measureText(E).width);
        m = !0;
        if (E.length === h.length || " " === h[E.length]) m = !1;
        m && (h = E.split(" "), 1 < h.length && h.pop(), E = h.join(" "), r = this.ctx.measureText(E).width);
        return {
            text: E,
            width: r
        }
    ...
    ka.prototype._wrapText = function() {
        ...
        if (0 === this.frontSize) w = v = 0;
            ...
            for (; 0 < h.length;) {
                var A = this.maxHeight - (this.topPadding +
                        this.bottomPadding),
    ...
    za.prototype.setLayout = function() {
        if (this.text) {
            ...
            r(this.padding) || "number" !== typeof this.padding ? r(this.padding) || "object" !==
                typeof this.padding || (Q = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0, Q += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0) : Q = 2 * this.padding;
            this.wrap || (I = Math.min(I, 1.5 * this.fontSize + Q));
            I = new ka(this.ctx, {
            ...
            Q = I.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (w = m.y1 + 2, J = "top") : "bottom" === this.verticalAlign && (w = m.y2 - 2 - Q.height, J = "bottom"), "left" === this.horizontalAlign ? v = m.x1 + 2 : "center" === this.horizontalAlign ? v = m.x1 + m.width / 2 - Q.width / 2 : "right" === this.horizontalAlign && (v = m.x2 - 2 - Q.width - E), K = this.horizontalAlign,
                this.width = Q.width, this.height = Q.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (v = m.x1 + 2, w = m.y2 - 2 - (this.maxWidth / 2 - Q.width / 2), A = -90, J = "left", this.width = Q.height, this.height = Q.width) : "right" === this.horizontalAlign ? (v = m.x2 - 2, w = m.y1 + 2 + (this.maxWidth / 2 - Q.width / 2), A = 90, J = "right", this.width = Q.height, this.height = Q.width) : "center" === this.horizontalAlign && (w = h.y1 + (h.height / 2 - Q.height / 2), v = h.x1 + (h.width / 2 - Q.width / 2), J = "center", this.width = Q.width, this.height = Q.height), K = "center");
            I.x =
                v;
            I.y = w;
            I.angle = A;
    ...
    Ua.prototype.get = function(h, r) {
        var v =
            null;
        0 < this.pool.length ? (v = this.pool.pop(), Ma(v, h, r)) : v = va(h, r);
        return v
    };
    ...
    var Pa = {
        ...
        formatNumber: function(h, r, v) {
            v = v || "en";
            if (Ka[v]) return ha(h, r || "#,##0.##", new Ja(v));
            throw "Unknown Culture Name";
        },
        formatDate: function(h, r, v) {
            v = v || "en";
            if (Ka[v]) return Ba(h, r || "DD MMM YYYY", new Ja(v));
            throw "Unknown Culture Name";
        }
    };
    "undefined" !== typeof module &&
        "undefined" !== typeof module.exports ? module.exports = Pa : "function" === typeof define && define.amd ? define([], function() {
            return Pa
    ...
    w = Pa.Chart = function() {
        ...
        function m(a, d, c) {
            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.inne.php = "", d = a = 0, a = this.options.width ?
                ...
                (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ca(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Ca(this._preRenderCtx), v ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = va(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")),
                    this.overlaidCanvas = va(a, d), this.overlaidCanvas.style.position = "absolute", this.overlaidCanvas.style.webkitTapHighlightColor = "transparent", this.overlaidCanvas.style.WebkitUserSelect = "none", this.overlaidCanvas.style.MozUserSelect = "none", this.overlaidCanvas.style.msUserSelect = "none", this.overlaidCanvas.style.userSelect = "none", this.overlaidCanvas.getContext && (this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline =
                        "top", Ca(this.overlaidCanvasCtx)), this._eventManager = new Z(this), this.windowResizeHandler = J(window, "resize", function() {
                        ...
                        b._mouseEventHandler(a)
                    }, this.allDOMEventHandlers), J(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" :
                        "touchstart",
                        function(a) {
                    ...
                    this.toolTip = new $(this, this.options.toolTip), this.data = null, this.axisX = [], this.axisX2 = [], this.axisY = [], this.axisY2 = [], this.sessionVariables = {
                        axisX: [],
                        axisX2: [],
                        axisY: [],
                        axisY2: []
        ...
        function w(a, d) {
            for (var c = [], b, e = 0; e < a.length; e++)
                if (0 == e) c.push(a[0]);
                    ...
                    b = Math.abs((a[l].x - a[f].x) / (0 === a[l].x - a[s].x ? 0.01 : a[l].x - a[s].x)) * (d - 1) /
                        2 + 1;
                    var C = (a[l].x - a[f].x) / b;
                    b = (a[l].y - a[f].y) / b;
                    c[c.length] = a[s].x > a[f].x && 0 < C || a[s].x < a[f].x && 0 > C ? {
                        x: a[s].x + C / 3,
                        y: a[s].y + b / 3
                    } : {
                        x: a[s].x,
                    ...
                    f = 0 === s ? 0 : s - 1;
                    l = s === a.length - 1 ? s : s + 1;
                    b = Math.abs((a[l].x - a[f].x) / (0 === a[s].x - a[f].x ? 0.01 : a[s].x - a[f].x)) * (d - 1) / 2 + 1;
                    C = (a[l].x - a[f].x) / b;
                    b = (a[l].y - a[f].y) / b;
                    c[c.length] = a[s].x > a[f].x && 0 < C || a[s].x < a[f].x && 0 > C ? {
                        x: a[s].x - C / 3,
        ...
        function A(a, d, c, b, e, f, l, s, C, k) {
            var n = 0;
            k ? (l.color = f, s.color = f) :
                k = 1;
            ...
            a.setLineDash && a.setLineDash(I(s.dashType, s.thickness));
            a.beginPath();
            C && 0 < s.thickness ? (a.moveTo(b - l.thickness / 2, Math.round((c + e) / 2) - p), a.lineTo(d + l.thickness / 2, Math.round((c + e) / 2) - p)) : 0 < s.thickness && (a.moveTo(Math.round((d +
                b) / 2) - p, c + l.thickness / 2), a.lineTo(Math.round((d + b) / 2) - p, e - l.thickness / 2));
            a.stroke();
            a.strokeStyle = l.color || f;
            a.lineWidth = l.thickness || 2;
            a.setLineDash && a.setLineDash(I(l.dashType, l.thickness));
            a.beginPath();
            C && 0 < l.thickness ? (a.moveTo(b - n, c), a.lineTo(b - n, e), a.moveTo(d + n, c), a.lineTo(d + n, e)) : 0 < l.thickness && (a.moveTo(d, c + n), a.lineTo(b, c + n), a.moveTo(d, e - n), a.lineTo(b, e - n));
            a.stroke();
            a.restore()
        }

        function P(a, d) {
            P.base.constructor.call(this, "Legend", "legend", d, null, a);
            this.chart = a;
        ...
        function X(a, d, c, b) {
            X.base.constructor.call(this, "DataSeries", "data", d, c,
                a);
            this.chart = a;
            this.canvas = a.canvas;
        ...
        function E(a, d, c, b, e, f) {
            ...
            this.options.scaleBreaks && (this.scaleBreaks = new ea(this.chart, this.options.scaleBreaks,
                ++this.chart._eventManager.lastObjectId, this));
            this.stripLines = [];
            if (this.options.stripLines && 0 < this.options.stripLines.length)
                for (a = 0; a < this.options.stripLines.length; a++) this.stripLines.push(new Q(this.chart, this.options.stripLines[a], a, ++this.chart._eventManager.lastObjectId, this));
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (this._zoomButton) V(this._zoomButton, {
                    ...
                    J(this._zoomButton, "click", function() {
                        a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, xa(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, xa(a, a._zoomButton, "pan"));
                        a.render()
                    }, this.allDOMEventHandlers);
                ...
                this._resetButton ? (V(this._resetButton, {
                    ...
                    this.toolbar.buttonBorderColor, this._toolBar.appendChild(this._resetButton), J(this._resetButton, "touchstart", function(a) {
                        d = !0
                        ...
                        a.zoomEnabled || a.panEnabled ? (a.zoomEnabled = !0, a.panEnabled = !1, xa(a, a._zoomButton, "pan"), a._defaultCursor = "default", a.overlaidCanvas.style.cursor = a._defaultCursor) : (a.zoomEnabled = !1, a.panEnabled = !1);
                    ...
                    J(this._resetButton, "mousemove", function() {
                        d || (V(a._resetButton, {
                            backgroundColor: a.toolbar.itemBackgroundColorOnHover,
                            color: a.toolbar.fontColorOnHover,
                            transition: "0.4s",
            ...
            if (this.options.data) {
                for (var c = 0; c < this.options.data.length; c++)
                    if (a++, !this.options.data[c].type ||
                        ...
                        var b = new X(this, this.options.data[c], a - 1, ++this._eventManager.lastObjectId);
        ...
        m.prototype.setLayout = function() {
            ...
            for (d = 0; d < this._axes.length; d++)
                if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) {
                    v ? (this._breaksCanvas = va(this.width, this.height, !0), this._breaksCanvasCtx = this._breaksCanvas.getContext("2d")) : (this._breaksCanvas = this.canvas, this._breaksCanvasCtx = this.ctx);
                    break
                }
        ...
        m.prototype.renderElements = function() {
            ...
            for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
                    ...
                    s.targetCanvas = null;
                    this.animatedRender && (s.targetCanvas = va(this.width, this.height), s.targetCanvasCtx = s.targetCanvas.getContext("2d"), e = s.targetCanvasCtx.miterLimit, s.targetCanvasCtx.miterLimit = 3);
                    "line" === s.type ? C = this.renderLine(s) : "stepLine" === s.type ? C = this.renderStepLine(s) : "spline" === s.type ? C = this.renderSpline(s) : "column" === s.type ? C = this.renderColumn(s) : "bar" === s.type ? C = this.renderBar(s) : "area" === s.type ? C = this.renderArea(s) : "stepArea" === s.type ? C = this.renderStepArea(s) :
                        ...
                        s.type && (C = this.renderBoxAndWhisker(s));
                    for (var k = 0; k < s.dataSeriesIndexes.length; k++) this._dataInRenderedOrder.push(this.data[s.dataSeriesIndexes[k]]);
                    this.animatedRender && (s.targetCanvasCtx.miterLimit = e, C && c.push(C))
                }
            ...
            this.animatedRender && 0 < this._indexLabels.length &&
                (e = va(this.width, this.height).getContext("2d"), c.push(this.renderIndexLabels(e)));
            var n = this;
        ...
        m.prototype._processMultiseriesPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (s.dataPoints[C].x && s.dataPoints[C].x.getTime || "dateTime" === s.xValueType) f = !0;
                    for (C = 0; C < s.dataPoints.length; C++) {
                        "undefined" === typeof s.dataPoints[C].x && (s.dataPoints[C].x = C + (a.axisX.logarithmic ? 1 : 0));
                        s.dataPoints[C].x.getTime ? (f = !0, b = s.dataPoints[C].x.getTime()) : b = s.dataPoints[C].x;
                        e = s.dataPoints[C].y;
                        b < c.min && (c.min = b);
                        b > c.max && (c.max = b);
                        ...
                        if (0 < C) {
                            if (a.axisX.logarithmic) {
                                var t = b / s.dataPoints[C - 1].x;
                                1 > t && (t = 1 / t);
                                c.minDiff > t && 1 !== t && (c.minDiff = t)
                            } else t = b - s.dataPoints[C - 1].x, 0 > t && (t *= -1), c.minDiff > t && 0 !== t && (c.minDiff = t);
                            null !== e && null !== s.dataPoints[C - 1].y && (a.axisY.logarithmic ? (t = e / s.dataPoints[C - 1].y, 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e - s.dataPoints[C - 1].y, 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t)))
                        }
                        if (b < q && !k) null !== e && (p = b);
                        else {
                            if (!k && (k = !0, 0 < C)) {
                            ...
                            s.dataPoints[C].label && (a.axisX.labels[b] = s.dataPoints[C].label);
        ...
        m.prototype._processStackedPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d =
                        a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], s = [], C = Infinity, k = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var p = this.data[a.dataSeriesIndexes[n]],
                        q = 0,
                        g = !1,
                        t = !1,
                        h;
                    if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement) var L = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
                    ...
                    for (q = 0; q < p.dataPoints.length; q++) {
                        ...
                        if (b < L &&
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === p.dataPoints[q].y ? c.viewPortMin === b && h < b && (c.viewPortMin = h) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l[b] ? l[b] += e : (l[b] = e, C = Math.min(e, C)) : s[b] ? s[b] += e : (s[b] = e, k = Math.max(e,
                                k)))
                        }
                    }
                    a.axisY.scaleBreaks && (a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks) && (d.dataPointYPositiveSums ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, l), d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, s)) : (d.dataPointYPositiveSums = l, d.dataPointYNegativeSums = s));
                    p.axisX.valueType = p.xValueType = f ? "dateTime" : "number"
                }
                for (q in l) l.hasOwnProperty(q) && !isNaN(q) && (a = l[q], a < d.min && (d.min = Math.min(a, C)), a > d.max && (d.max = a), q < c.viewPortMin || q > c.viewPortMax ||
                    (a < d.viewPortMin && (d.viewPortMin = Math.min(a, C)), a > d.viewPortMax && (d.viewPortMax = a)));
                for (q in s) s.hasOwnProperty(q) && !isNaN(q) && (a = s[q], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, k)), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, k))))
            }
        };
        m.prototype._processStacked100PlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, s = !1, C = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var n =
                    ...
                    for (p = 0; p < n.dataPoints.length; p++) {
                        ...
                        if (b < h && !q) null !== e && (t = b);
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === e ? c.viewPortMin === b && t < b && (c.viewPortMin = t) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l = !0 : 0 > e && (s = !0), C[b] = C[b] ? C[b] + Math.abs(e) : Math.abs(e))
                        }
                    }
        ...
        m.prototype._processMultiYPlotUnit = function(a) {
            if (a.dataSeriesIndexes &&
                ...
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, s = !1, C = 0; C < a.dataSeriesIndexes.length; C++) {
                    ...
                    if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement) var r = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum :
                        ...
                        u = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity;
                    if (k.dataPoints[n].x && k.dataPoints[n].x.getTime || "dateTime" === k.xValueType) s = !0;
                    for (n = 0; n < k.dataPoints.length; n++) {
                        ...
                        k.dataPoints[n].x.getTime ?
                            (s = !0, b = k.dataPoints[n].x.getTime()) : b = k.dataPoints[n].x;
                        ...
                        f < d.min && (d.min = f);
                        l > d.max && (d.max = l);
                        0 < n && (a.axisX.logarithmic ? (t = b / k.dataPoints[n - 1].x, 1 > t && (t = 1 / t), c.minDiff > t && 1 !== t && (c.minDiff = t)) : (t = b - k.dataPoints[n - 1].x, 0 > t && (t *= -1), c.minDiff > t && 0 !== t && (c.minDiff = t)), e && (null !== e[0] && k.dataPoints[n - 1].y && null !==
                            k.dataPoints[n - 1].y[0]) && (a.axisY.logarithmic ? (t = e[0] / k.dataPoints[n - 1].y[0], 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e[0] - k.dataPoints[n - 1].y[0], 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t))));
                        if (!(b < r) || p) {
                            if (!p && (p = !0, 0 < n)) {
                                n -= 2;
                                g = h;
            ...
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    var s = this.data[a.dataSeriesIndexes[l]],
                        ...
                        n = !1,
                        p = b = 0;
                    if ("normal" === s.axisPlacement || "xySwapped" ===
                    ...
                    for (C = 0; C < s.dataPoints.length; C++)
                        if ("undefined" ===
                            typeof s.dataPoints[C].x && (s.dataPoints[C].x = C + (a.axisX.logarithmic ? 1 : 0)), s.dataPoints[C].x.getTime ? (f = !0, b = s.dataPoints[C].x.getTime()) : b = s.dataPoints[C].x, e = s.dataPoints[C].y, b < c.min && (c.min = b), b > c.max && (c.max = b), s.dataPointEOs[C].cumulativeSum < d.min && (d.min = s.dataPointEOs[C].cumulativeSum), s.dataPointEOs[C].cumulativeSum > d.max && (d.max = s.dataPointEOs[C].cumulativeSum), 0 < C && (a.axisX.logarithmic ? (p = b / s.dataPoints[C - 1].x, 1 > p && (p = 1 / p), c.minDiff > p && 1 !== p && (c.minDiff = p)) : (p = b - s.dataPoints[C - 1].x, 0 > p &&
                                (p *= -1), c.minDiff > p && 0 !== p && (c.minDiff = p)), null !== e && null !== s.dataPoints[C - 1].y && (a.axisY.logarithmic ? (e = s.dataPointEOs[C].cumulativeSum / s.dataPointEOs[C - 1].cumulativeSum, 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = s.dataPointEOs[C].cumulativeSum - s.dataPointEOs[C - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < q) || k) {
                            if (!k && (k = !0, 0 < C)) {
                                C -= 2;
                                continue
                            }
                            ...
                            b < c.viewPortMin &&
                                (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            0 < C && (s.dataPointEOs[C - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = s.dataPointEOs[C - 1].cumulativeSum), s.dataPointEOs[C - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = s.dataPointEOs[C - 1].cumulativeSum));
                            s.dataPointEOs[C].cumulativeSum < d.viewPortMin && (d.viewPortMin = s.dataPointEOs[C].cumulativeSum);
                            s.dataPointEOs[C].cumulativeSum > d.viewPortMax && (d.viewPortMax = s.dataPointEOs[C].cumulativeSum)
                        }
                    s.axisX.valueType = s.xValueType = f ? "dateTime" : "number"
                }
        };
        m.prototype.calculateAutoBreaks = function() {
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c)
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, l = f.min, k = f.max, n = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, s = 0, C = 0; C < a.dataSeriesIndexes.length; C++) {
                            var h = e.data[a.dataSeriesIndexes[C]];
                            if (!(4 > h.dataPoints.length))
                                for (s = 0; s < h.dataPoints.length; s++)
                                    if (b && (q = (k + 1 - l) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = h.dataPoints[s].x.getTime ? h.dataPoints[s].x.getTime() : h.dataPoints[s].x, q = Math.floor((g - l) / q), g < f[q].min &&
                                            (f[q].min = g), g > f[q].max && (f[q].max = g)), c) {
                                        var m = (p + 1 - n) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100;
                                        if ((g = "waterfall" === a.type ? h.dataPointEOs[s].cumulativeSum : h.dataPoints[s].y) && g.length)
                                            for (var v = 0; v < g.length; v++) q = Math.floor((g[v] - n) / m), g[v] < d[q].min && (d[q].min = g[v]), g[v] > d[q].max && (d[q].max = g[v]);
            ...
            for (var b, e = this, f = !1, l = 0; l < this._axes.length; l++)
                if (this._axes[l].scaleBreaks && this._axes[l].scaleBreaks.autoCalculate && 1 <= this._axes[l].scaleBreaks.maxNumberOfAutoBreaks) {
                    ...
                    for (var s = 0; s < 100 / Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) || 10, 10); s++) this._axes[l].dataInfo._dataRanges.push({
                        min: Infinity,
                        max: -Infinity
                    })
                }
            if (f) {
                for (l = 0; l < this.plotInfo.plotTypes.length; l++)
                    for (f = this.plotInfo.plotTypes[l], s = 0; s < f.plotUnits.length; s++) b =
                ...
                for (l = 0; l < this._axes.length; l++)
                    if (this._axes[l].dataInfo._dataRanges) {
                        ...
                        if (this._axes[l].dataInfo.dataPointYNegativeSums) {
                            ...
                            n = k;
                            for (s in q) q.hasOwnProperty(s) && !isNaN(s) && (p = -1 * q[s], r(p) || (g = Math.floor((p - C) / b), p < n[g].min && (n[g].min = p), p > n[g].max && (n[g].max = p)));
                            delete this._axes[l].dataInfo.dataPointYNegativeSums
                        }
                        for (s = 0; s < k.length - 1; s++)
                            if (n = k[s].max, isFinite(n))
                                for (; s < k.length - 1;)
                                    if (C = k[s + 1].min, isFinite(C)) {
                                        p = C - n;
                                        p > b && f.push({
                                            diff: p,
                                            start: n,
                        ...
                        if (this._axes[l].scaleBreaks.customBreaks)
                            for (s = 0; s < this._axes[l].scaleBreaks.customBreaks.length; s++)
                                for (b =
                                    0; b < f.length; b++)
        ...
        m.prototype.getObjectAtXY = function(a, d, c) {
            ...
            else if (v) b = Za(a, d, this._eventManager.ghostCtx);
            else
        ...
        m.prototype._mouseEventHandler = function(a) {
            ...
            m.capturedEventParam && (b = m.capturedEventParam, "mouseup" === c && (m.capturedEventParam = null, b.chart.overlaidCanvas.releaseCapture ? b.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup",
                b.chart._mouseEventHandler, !1)), b.hasOwnProperty(c) && ("mouseup" !== c || b.chart.overlaidCanvas.releaseCapture ? a.target !== b.chart.overlaidCanvas && v || b[c].call(b.context, d.x, d.y) : a.target !== b.chart.overlaidCanvas && (b.chart.isDrag = !1)));
        ...
        m.prototype._plotAreaMouseUp = function(a, d) {
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                ...
                if ("xySwapped" === this.plotInfo.axisPlacement) var s = f,
                    f = e,
                    e = s;
        ...
        m.prototype._plotAreaMouseMove = function(a, d) {
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if (2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled)) {
                    ...
                    for (var s = 0; s < this.axisX.length; s++) this.axisX[s].crosshair && this.axisX[s].crosshair.enabled && (this.axisX[s].crosshair.hide(), this.axisX[s].crosshair.dispatchEvent("hidden", {
                        chart: this,
                        axis: this.axisX[s].options
                    }, this.axisX[s].crosshair));
                    for (s = 0; s < this.axisX2.length; s++) this.axisX2[s].crosshair && this.axisX2[s].crosshair.enabled && (this.axisX2[s].crosshair.hide(), this.axisX2[s].crosshair.dispatchEvent("hidden", {
                        chart: this,
                        axis: this.axisX2[s].options
                    }, this.axisX2[s].crosshair));
                    for (s = 0; s < this.axisY.length; s++) this.axisY[s].crosshair && this.axisY[s].crosshair.enabled && (this.axisY[s].crosshair.hide(), this.axisY[s].crosshair.dispatchEvent("hidden", {
                            chart: this,
                            axis: this.axisY[s].options
                        },
                        this.axisY[s].crosshair));
                    for (s = 0; s < this.axisY2.length; s++) this.axisY2[s].crosshair && this.axisY2[s].crosshair.enabled && (this.axisY2[s].crosshair.hide(), this.axisY2[s].crosshair.dispatchEvent("hidden", {
                        chart: this,
                        axis: this.axisY2[s].options
                ...
                if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
                    ...
                    this.validateRegion(b, s, e ? a : this.plotArea.x2 - this.plotArea.x1, f ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(), this.overlaidCanvasCtx.fillStyle = "#99B2B5");
                    this.overlaidCanvasCtx.globalAlpha = 0.7;
                    this.overlaidCanvasCtx.fillRect(b, s, C, k);
        ...
        m.prototype.validateRegion = function(a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), s = !1, C = [], k = [], n = [], p = 0; p < this._axes.length; p++)("axisX" === this._axes[p].type &&
            ...
            for (l = 0; l < k.length; l++) {
                ...
                if (q > g) var t = g,
                    ...
                    q = t;
                if (p.scaleBreaks)
                    for (t = 0; !f && t < p.scaleBreaks._appliedBreaks.length; t++) f = p.scaleBreaks._appliedBreaks[t].startValue <= q && p.scaleBreaks._appliedBreaks[t].endValue >= g;
                if (isFinite(p.dataInfo.minDiff))
                    if (t = p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) &&
                            (p.logarithmic && t < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && t < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) C.push(p), n.push({
                        val1: q,
                        val2: g
                    }), s = !0;
                    else if (!e) {
        ...
        m.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var n = this._indexLabels[a],
                    ...
                    q, g, l = ma("indexLabelFontColor", n.dataPoint, n.dataSeries),
                    t = ma("indexLabelFontSize", n.dataPoint, n.dataSeries),
                    s = ma("indexLabelFontFamily", n.dataPoint, n.dataSeries),
                    C = ma("indexLabelFontStyle", n.dataPoint, n.dataSeries),
                    k = ma("indexLabelFontWeight", n.dataPoint, n.dataSeries),
                    h = ma("indexLabelBackgroundColor", n.dataPoint, n.dataSeries);
                q = ma("indexLabelMaxWidth", n.dataPoint, n.dataSeries);
                g = ma("indexLabelWrap", n.dataPoint, n.dataSeries);
                var L = ma("indexLabelLineDashType", n.dataPoint, n.dataSeries),
                    u = ma("indexLabelLineColor", n.dataPoint, n.dataSeries),
                ...
                if (n.dataSeries.indexLabelFormatter || n.dataPoint.indexLabelFormatter) B = {
                    chart: this,
                ...
                var D = n.dataPoint.indexLabelFormatter ? n.dataPoint.indexLabelFormatter(B) : n.dataPoint.indexLabel ? this.replaceKeywordsWithValue(n.dataPoint.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : n.dataSeries.indexLabelFormatter ?
                    n.dataSeries.indexLabelFormatter(B) : n.dataSeries.indexLabel ? this.replaceKeywordsWithValue(n.dataSeries.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : null;
                if (null !== D && "" !== D) {
                    var x = ma("indexLabelPlacement", n.dataPoint, n.dataSeries),
                        B = ma("indexLabelOrientation", n.dataPoint, n.dataSeries),
                        z = ma("indexLabelTextAlign", n.dataPoint, n.dataSeries),
                        w = n.direction,
                    ...
                    l = s = 2;
                    "horizontal" === B ? (C = h.width, k = h.height) : (k = h.width, C = h.height);
                    if ("normal" ===
                        this.plotInfo.axisPlacement) {
                        if (0 <= p.indexOf("line") || 0 <= p.indexOf("area")) x = "auto", s = 4;
                        else if (0 <= p.indexOf("stacked")) "auto" === x && (x = "inside");
                        else if ("bubble" === p || "scatter" === p) x = "inside";
                        q = n.point.x - ("horizontal" === B ? C / 2 : C / 2 - t / 2);
                        "inside" !== x ? (e = c.y1, f = c.y2, 0 < w ? (g = n.point.y + ("horizontal" === B ? t / 2 : 0) - k - s - b, g < e && (g = "auto" === x ? Math.max(n.point.y, e) + t / 2 + s : e + t / 2 + s, E = g + k > n.point.y)) : (g = n.point.y + t / 2 + s + b, g > f - k && (g = "auto" === x ? Math.min(n.point.y, f) + t / 2 - k - s : f + t / 2 - k, E = g < n.point.y))) : (e = Math.max(n.bounds.y1,
                            c.y1), f = Math.min(n.bounds.y2, c.y2 - k + t / 2), b = 0 <= p.indexOf("range") || "error" === p ? 0 < w ? Math.max(n.bounds.y1, c.y1) + t / 2 + s : Math.min(n.bounds.y2, c.y2) + t / 2 - k + s : (Math.max(n.bounds.y1, c.y1) + Math.min(n.bounds.y2, c.y2)) / 2 - k / 2 + t / 2 + ("horizontal" === B ? s : 0), 0 < w ? (g = Math.max(n.point.y, b), g < e && ("bubble" === p || "scatter" === p) && (g = Math.max(n.point.y - k - s, c.y1 + s))) : (g = Math.min(n.point.y, b), g > f - k - s && ("bubble" === p || "scatter" === p) && (g = Math.min(n.point.y + s, c.y2 - k - s))), g = Math.min(g, f))
                        ...
                        0 <= p.indexOf("scatter") ? (x = "auto", l = 4) : 0 <= p.indexOf("stacked") ? "auto" === x && (x = "inside") : "bubble" === p && (x = "inside"), g = n.point.y + t / 2 - k / 2 + s, "inside" !== x ? (e = c.x1, f = c.x2, 0 > w ? (q = n.point.x - ("horizontal" === B ? C : C - t / 2) - l - b, q < e && (q = "auto" === x ? Math.max(n.point.x, e) + l : e + l, E = q + C > n.point.x)) : (q = n.point.x + ("horizontal" === B ? 0 : t / 2) + l + b, q > f - C - l - b && (q = "auto" === x ? Math.min(n.point.x, f) - ("horizontal" === B ? C : C / 2) - l : f - C - l, E = q < n.point.x))) : (e = Math.max(n.bounds.x1, c.x1), Math.min(n.bounds.x2, c.x2), b = 0 <= p.indexOf("range") || "error" ===
                            p ? 0 > w ? Math.max(n.bounds.x1, c.x1) + t / 2 + l : Math.min(n.bounds.x2, c.x2) - C / 2 - l + ("horizontal" === B ? 0 : t / 2) : (Math.max(n.bounds.x1, c.x1) + Math.min(n.bounds.x2, c.x2)) / 2 + ("horizontal" === B ? 0 : t / 2), q = 0 > w ? Math.max(n.point.x, b) - ("horizontal" === B ? C / 2 : 0) : Math.min(n.point.x, b) - C / 2, q = Math.max(q, e));
                    "vertical" === B && (g += k - t / 2);
                    h.x = q;
                    h.y = g;
                    h.render(!0);
                    m && ("inside" !== x && (0 > p.indexOf("bar") && ("error" !== p || !n.axisSwapped) && n.point.x > c.x1 && n.point.x < c.x2 || !E) && (0 > p.indexOf("column") && ("error" !== p || n.axisSwapped) && n.point.y > c.y1 &&
                        ...
                        B ? g - k < n.point.y ? 0 : -k : (g - t / 2 < n.point.y ? k : 0) - t / 2)), d.stroke())
                }
            }
            d = {
                source: d,
            ...
            for (a = 0; a < this._indexLabels.length; a++) n = this._indexLabels[a], h = ma("indexLabelBackgroundColor", n.dataPoint, n.dataSeries), n.dataSeries.indexLabelBackgroundColor = r(h) ? v ? "transparent" : null : h;
            return d
        };
        m.prototype.renderLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    var t = k._colorSet,
                        h = t = k.lineColor = k.options.lineColor ? k.options.lineColor : t[0];
                    c.strokeStyle = t;
                    var r = !0,
                        u = 0,
                        m, x;
                    c.beginPath();
                    if (0 < n.length) {
                        for (var B = !1, u = 0; u < n.length; u++)
                            if (m = n[u].x.getTime ? n[u].x.getTime() : n[u].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !B)))
                                if ("number" !== typeof n[u].y) 0 < u && !(k.connectNullData || B || r) && (c.stroke(), v && b.stroke()), B = !0;
                                else {
                                    ...
                                    r || B ? (!r && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(m, x), v && b.lineTo(m, x)) : (c.beginPath(), c.moveTo(m, x), v && (b.beginPath(),
                                        b.moveTo(m, x))), B = r = !1) : (c.lineTo(m, x), v && b.lineTo(m, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(m, x), v && (b.stroke(), b.beginPath(), b.moveTo(m, x))));
                                    l = {
                                        x: m,
                                        y: x
                                    };
                                    u < n.length - 1 && (h !== (n[u].lineColor || t) || p !== (n[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(m, x), h = n[u].lineColor || t, c.strokeStyle = h, c.setLineDash && (n[u].lineDashType ? (p = n[u].lineDashType, c.setLineDash(I(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));
                                    if (0 < n[u].markerSize || 0 < k.markerSize) {
                                        var z = k.getMarkerProperties(u,
                                            m, x, c);
                                        f.push(z);
                                        D = O(D);
                                        v && f.push({
                                    ...
                                    }(n[u].indexLabel || k.indexLabel || n[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: "line",
                                        dataPoint: n[u],
                                        dataSeries: k,
                                        point: {
                ...
                ba.drawMarkers(f);
                v && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop",
        ...
        m.prototype.renderStepLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < n.length) {
                        for (var B = !1, u = 0; u < n.length; u++)
                            if (m = n[u].getTime ? n[u].x.getTime() : n[u].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !B)))
                                if ("number" !== typeof n[u].y) 0 <
                                    u && !(k.connectNullData || B || r) && (c.stroke(), v && b.stroke()), B = !0;
                                else {
                                    var D = x;
                                    m = a.axisX.convertValueToPixel(m);
                                    x = a.axisY.convertValueToPixel(n[u].y);
                                    ...
                                    r || B ? (!r && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)),
                                        c.lineTo(m, D), c.lineTo(m, x), v && (b.lineTo(m, D), b.lineTo(m, x))) : (c.beginPath(), c.moveTo(m, x), v && (b.beginPath(), b.moveTo(m, x))), B = r = !1) : (c.lineTo(m, D), v && b.lineTo(m, D), c.lineTo(m, x), v && b.lineTo(m, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(m, x), v && (b.stroke(), b.beginPath(), b.moveTo(m, x))));
                                    l = {
                                        x: m,
                                        y: x
                                    };
                                    u < n.length - 1 && (h !== (n[u].lineColor || t) || p !== (n[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(m, x), h = n[u].lineColor || t, c.strokeStyle = h, c.setLineDash && (n[u].lineDashType ? (p = n[u].lineDashType,
                                        c.setLineDash(I(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));
                                    if (0 < n[u].markerSize || 0 < k.markerSize) D = k.getMarkerProperties(u, m, x, c), f.push(D), z = O(z), v && f.push({
                                        x: m,
                                        y: x,
                                        ctx: b,
                                        type: D.type,
            ...
            function d(a) {
                ...
                if (0 < a.length) {
                    ...
                    for (var c = 0; c < a.length - 3; c += 3)
                        if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), v && e.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c +
                                2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), 0 < c && 0 === c % 3E3 || a[c + 3].newStrokeStyle || a[c + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(a[c + 3].x, a[c + 3].y), a[c + 3].newStrokeStyle && (b.strokeStyle = a[c + 3].newStrokeStyle), a[c + 3].newLineDashArray && b.setLineDash(a[c + 3].newLineDashArray), v && (e.stroke(), e.beginPath(), e.moveTo(a[c + 3].x, a[c + 3].y));
                    b.stroke();
                    v && e.stroke()
                }
            }
                        ...
                        for (m = !1, r = 0; r < n.length; r++)
                            if (u = n[r].getTime ? n[r].x.getTime() : n[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !m)))
                                if ("number" !== typeof n[r].y) 0 < r && !m && (k.connectNullData ? b.setLineDash && (0 < x.length && (k.options.nullDataLineDashType || !n[r - 1].lineDashType)) && (x[x.length - 1].newLineDashArray = q, p = k.nullDataLineDashType) :
                                    ...
                                    r < n.length - 1 && (h !== (n[r].lineColor || t) || p !== (n[r].lineDashType || k.lineDashType)) && (h = n[r].lineColor || t, x[x.length - 1].newStrokeStyle = h, b.setLineDash && (n[r].lineDashType ? (p = n[r].lineDashType, x[x.length - 1].newLineDashArray = I(p, k.lineThickness)) : (p = k.lineDashType,
                                        x[x.length - 1].newLineDashArray = g)));
                                    if (0 < n[r].markerSize || 0 < k.markerSize) {
                                        var D = k.getMarkerProperties(r, u, m, b);
                                        l.push(D);
                                        B = O(B);
                                        v && l.push({
                                            x: u,
                                    ...
                                    }(n[r].indexLabel || k.indexLabel || n[r].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: "spline",
                                        dataPoint: n[r],
                                        dataSeries: k,
                                        point: {
        ...
        m.prototype.renderColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    l, s, C, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var q = a.dataSeriesIndexes[n],
                        ...
                        t = g.dataPoints;
                    if (0 < t.length)
                        for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < t.length; f++)
                            if (t[f].getTime ? C = t[f].x.getTime() :
                                C = t[f].x, !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[f].y) {
                                ...
                                0 <= t[f].y ? u = k : (u = s, s = k);
                                s > u && (b = s, s = u, u = b);
                                b = t[f].color ? t[f].color : g._colorSet[f % g._colorSet.length];
                                da(c, a.axisX.reversed ? r : l, s, a.axisX.reversed ?
                                    l : r, u, b, 0, null, h && (a.axisY.reversed ? 0 > t[f].y : 0 <= t[f].y), (a.axisY.reversed ? 0 <= t[f].y : 0 > t[f].y) && h, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = O(b);
                                v && da(this._eventManager.ghostCtx, a.axisX.reversed ? r : l, s, a.axisX.reversed ? l : r, u, b, 0, null, !1, !1, !1, !1);
                                (t[f].indexLabel || g.indexLabel || t[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "column",
                                    dataPoint: t[f],
                                    dataSeries: g,
                                    point: {
        ...
        m.prototype.renderStackedColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                c.rect(e.x1, e.y1, e.width, e.height);
                c.clip();
                v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1,
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                var x = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    B = x + g << 0,
                                    D;
                                if (a.axisY.logarithmic ||
                                    a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) s[b] = u[k].y + (s[b] ? s[b] : 0), 0 < s[b] && (p = a.axisY.convertValueToPixel(s[b]), D = "undefined" !== typeof f[b] ? f[b] : q, f[b] = p);
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) C[b] = u[k].y + (C[b] ? C[b] : 0), D = a.axisY.convertValueToPixel(C[b]), p = "undefined" !== typeof l[b] ? l[b] : q, l[b] = D;
                                    ...
                                    l[b] ? l[b] : 0, D = p + z, p = q + z, l[b] = z + (D - p);
                                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                                da(c, x, a.axisY.reversed ? D : p, B, a.axisY.reversed ? p : D, b, 0, null, m && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y), (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) && m, !1, !1, r.fillOpacity);
                                b = r.dataPointIds[k];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = O(b);
                                v && da(this._eventManager.ghostCtx, x, p, B, D, b, 0, null, !1, !1, !1, !1);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    var h = a.dataSeriesIndexes[t],
                        ...
                        u = r.dataPoints;
                    if (0 < u.length)
                        for (var m = 5 < g && r.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                n = a.axisX.convertValueToPixel(b);
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                    ...
                                    D = f[b] ? f[b] : q;
                                    f[b] = p
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) C[b] = p + ("undefined" !== typeof C[b] ? C[b] : 0), D = a.axisY.convertValueToPixel(C[b]), p = l[b] ? l[b] : q, l[b] = D;
                                else if (p = a.axisY.convertValueToPixel(p), 0 <= u[k].y) {
                                    var z = "undefined" !== typeof f[b] ? f[b] : 0;
                                    p -= z;
                                    D = q - z;
                                    a.dataSeriesIndexes.length - 1 === t && 1 >= Math.abs(e.y1 - p) && (p = e.y1);
                                    f[b] = z + (D - p)
                                } else z = "undefined" !== typeof l[b] ? l[b] : 0, D = p + z, p = q + z, a.dataSeriesIndexes.length - 1 === t && 1 >= Math.abs(e.y2 - D) && (D = e.y2), l[b] = z + (D - p);
                                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                                da(c, x, a.axisY.reversed ? D : p, B, a.axisY.reversed ? p : D, b, 0, null, m && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y), (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) &&
                                    m, !1, !1, r.fillOpacity);
                                b = r.dataPointIds[k];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < t.length) {
                        ...
                        for (f = 0; f < t.length; f++)
                            if (t[f].getTime ? C = t[f].x.getTime() : C = t[f].x, !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[f].y) {
                                s = a.axisX.convertValueToPixel(C);
                                l = a.axisY.convertValueToPixel(t[f].y);
                                s = a.axisX.reversed ? s + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount + n) * p << 0 : s - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount +
                                    n) * p << 0;
                                var r = a.axisX.reversed ? s - p << 0 : s + p << 0,
                                    u;
                                0 <= t[f].y ? u = k : (u = l, l = k);
                                b = t[f].color ? t[f].color : g._colorSet[f % g._colorSet.length];
                                da(c, a.axisY.reversed ? l : u, a.axisX.reversed ? r : s, a.axisY.reversed ? u : l, a.axisX.reversed ? s : r, b, 0, null, h, !1, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = O(b);
                                v && da(this._eventManager.ghostCtx, u, a.axisX.reversed ? r : s, l, a.axisX.reversed ? s : r, b, 0, null, !1, !1, !1, !1);
                                (t[f].indexLabel ||
                                    g.indexLabel || t[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "bar",
                                    dataPoint: t[f],
                                    dataSeries: g,
                                    point: {
        ...
        m.prototype.renderStackedBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" ===
                                ...
                                var x = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    B = x + g << 0,
                                    D;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) s[b] = u[k].y + (s[b] ? s[b] : 0), 0 < s[b] && (D = f[b] ? f[b] : q, f[b] = n = a.axisY.convertValueToPixel(s[b]));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) C[b] = u[k].y + (C[b] ? C[b] : 0), n = l[b] ? l[b] : q, l[b] = D = a.axisY.convertValueToPixel(C[b]);
                                    ...
                                    n += z;
                                    f[b] = z + (n - D)
                                } else z = l[b] ? l[b] : 0, D = n - z, n = q - z, l[b] = z + (n - D);
                                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                                da(c, a.axisY.reversed ? n : D, x, a.axisY.reversed ? D : n, B, b, 0, null, m, !1, !1, !1, r.fillOpacity);
                                b = r.dataPointIds[k];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = O(b);
                                v && da(this._eventManager.ghostCtx, D, x, n, B, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter ||
                                    r.indexLabelFormatter) && this._indexLabels.push({
                ...
                v && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx &&
        ...
        m.prototype.renderStackedBar100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                    ...
                                    if (0 >= s[b]) continue;
                                    x = f[b] ? f[b] : q;
                                    f[b] = n = a.axisY.convertValueToPixel(s[b])
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) C[b] = x + (C[b] ? C[b] : 0), n = l[b] ? l[b] : q, l[b] = x = a.axisY.convertValueToPixel(C[b]);
                                else if (n = a.axisY.convertValueToPixel(x), 0 <= u[k].y) {
                                    var z =
                                        f[b] ? f[b] : 0;
                                    x = q + z;
                                    n += z;
                                    a.dataSeriesIndexes.length - 1 === t && 1 >= Math.abs(e.x2 - n) && (n = e.x2);
                                    f[b] = z + (n - x)
                                } else z = l[b] ? l[b] : 0, x = n - z, n = q - z, a.dataSeriesIndexes.length - 1 === t && 1 >= Math.abs(e.x1 - x) && (x = e.x1), l[b] = z + (n - x);
                                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                                da(c, a.axisY.reversed ? n : x, B, a.axisY.reversed ? x : n, D, b, 0, null, m, !1, !1, !1, r.fillOpacity);
                                b = r.dataPointIds[k];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                ...
                v && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height),
        ...
        m.prototype.renderArea =
            function(a) {
                ...
                function b() {
                    D && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? B = x : 0 > a.axisY.viewportMaximum ? B = s.y1 : 0 < a.axisY.viewportMinimum && (B = x), f.lineTo(r, B), f.lineTo(D.x, B), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, v && (l.lineTo(r, B), l.lineTo(D.x, B), l.closePath(), l.fill()), f.beginPath(), f.moveTo(r, u), l.beginPath(), l.moveTo(r, u), D = {
                        x: r,
                        y: u
                    })
                }
                var e = a.targetCanvasCtx || this.plotArea.ctx,
                    f = v ? this._preRenderCtx :
                    e;
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                        ...
                        if (0 < t.length) {
                            ...
                            c = "solid";
                            if (f.setLineDash) {
                                var T = I(g.nullDataLineDashType, g.lineThickness);
                                c = g.lineDashType;
                                var S = I(c, g.lineThickness);
                                f.setLineDash(S)
                            }
                            for (var fa = !0; h < t.length; h++)
                                if (m = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !fa)))
                                    if ("number" !==
                                        typeof t[h].y) g.connectNullData || (fa || d) || b(), fa = !0;
                                    else {
                                        r = a.axisX.convertValueToPixel(m);
                                        u = a.axisY.convertValueToPixel(t[h].y);
                                        d || fa ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = r, c = u, r = n.x, u = n.y, b(), f.moveTo(n.x, n.y), r = d, u = c, D = n, c = g.nullDataLineDashType, f.setLineDash(T)), f.lineTo(r, u), v && l.lineTo(r, u)) : (f.beginPath(), f.moveTo(r, u), v && (l.beginPath(), l.moveTo(r, u)), D = {
                                            x: r,
                                            y: u
                                        }), fa = d = !1) : (f.lineTo(r, u), v && l.lineTo(r,
                                            u), 0 == h % 250 && b());
                                        n = {
                                            x: r,
                                            y: u
                                        };
                                        h < t.length - 1 && (E !== (t[h].lineColor || w) || c !== (t[h].lineDashType || g.lineDashType)) && (b(), E = t[h].lineColor || w, f.strokeStyle = E, f.setLineDash && (t[h].lineDashType ? (c = t[h].lineDashType, f.setLineDash(I(c, g.lineThickness))) : (c = g.lineDashType, f.setLineDash(S))));
                                        ...
                                        0 !== t[h].markerSize && (0 < t[h].markerSize || 0 < g.markerSize) && (m = g.getMarkerProperties(h,
                                            r, u, f), C.push(m), aa = O(aa), v && C.push({
                                            x: r,
                                            y: u,
                                            ctx: l,
                                            type: m.type,
                                        ...
                                        (t[h].indexLabel || g.indexLabel || t[h].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                            chartType: "area",
                                            dataPoint: t[h],
                                            dataSeries: g,
                                            point: {
                    ...
                    v && (e.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), f.globalCompositeOperation = "source-atop", a.axisX.maskCanvas &&
        ...
        m.prototype.renderSplineArea = function(a) {
                ...
                if (0 < c.length) {
                    if (0 < n.lineThickness) {
                        ...
                        for (var d = 0; d < c.length - 3; d += 3)
                            if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), v && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle || c[d + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle && (b.strokeStyle =
                                c[d + 3].newStrokeStyle), c[d + 3].newLineDashArray && b.setLineDash(c[d + 3].newLineDashArray);
                        b.stroke()
                    }
                    b.beginPath();
                    b.moveTo(c[0].x, c[0].y);
                    v && (e.beginPath(), e.moveTo(c[0].x, c[0].y));
                    for (d = 0; d < c.length - 3; d += 3) b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), v && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y);
                    ...
                    b.fill();
                    b.globalAlpha = 1;
                    v && (e.lineTo(c[c.length - 1].x, m), e.lineTo(u.x, m), e.closePath(), e.fill())
                }
            }
            var c = a.targetCanvasCtx || this.plotArea.ctx,
                b = v ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                b.clip();
                v && (e.beginPath(), e.rect(s.x1, s.y1, s.width,
                    s.height), e.clip());
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    var l = [],
                        q = 0,
                        g, t, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        m, u = null,
                        y = [];
                    if (0 < p.length) {
                        var x = n._colorSet[q % n._colorSet.length],
                            B = n.lineColor = n.options.lineColor || x,
                            D = B;
                        b.fillStyle = x;
                        b.strokeStyle = B;
                        ...
                        var z = "solid";
                        if (b.setLineDash) {
                            var E = I(n.nullDataLineDashType, n.lineThickness),
                                z = n.lineDashType,
                                A = I(z, n.lineThickness);
                            b.setLineDash(A)
                        }
                        for (t = !1; q < p.length; q++)
                            if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !t)))
                                if ("number" !== typeof p[q].y) 0 < q && !t && (n.connectNullData ? b.setLineDash && (0 < y.length && (n.options.nullDataLineDashType || !p[q - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = E, z = n.nullDataLineDashType) : (d(), y = [])), t = !0;
                                else {
                                    g = a.axisX.convertValueToPixel(g);
                                    t = a.axisY.convertValueToPixel(p[q].y);
                                    var T = n.dataPointIds[q];
                                    this._eventManager.objectMap[T] = {
                                        id: T,
                                        objectType: "dataPoint",
                                        dataSeriesIndex: k,
                                    ...
                                    q < p.length - 1 && (D !== (p[q].lineColor || B) || z !== (p[q].lineDashType || n.lineDashType)) && (D = p[q].lineColor || B, y[y.length - 1].newStrokeStyle = D, b.setLineDash && (p[q].lineDashType ? (z = p[q].lineDashType, y[y.length - 1].newLineDashArray = I(z, n.lineThickness)) : (z = n.lineDashType, y[y.length - 1].newLineDashArray =
                                        A)));
                                    if (0 !== p[q].markerSize && (0 < p[q].markerSize || 0 < n.markerSize)) {
                                        var S = n.getMarkerProperties(q, g, t, b);
                                        l.push(S);
                                        T = O(T);
                                        v && l.push({
                                            x: g,
                ...
                v && (c.drawImage(this._preRenderCanvas,
                    0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(s.x1, s.y1, s.width, s.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
        ...
        m.prototype.renderStepArea = function(a) {
            ...
            function b() {
                D && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? B = x : 0 > a.axisY.viewportMaximum ? B = s.y1 : 0 < a.axisY.viewportMinimum && (B = x), f.lineTo(m, B), f.lineTo(D.x, B), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, v && (l.lineTo(m, B), l.lineTo(D.x, B), l.closePath(), l.fill()), f.beginPath(), f.moveTo(m, u), l.beginPath(), l.moveTo(m, u), D = {
                    x: m,
                    y: u
                })
            }
            var e = a.targetCanvasCtx ||
                this.plotArea.ctx,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    d = !0;
                    var r = 0,
                        m, u, y, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        B, D = null;
                    c = !1;
                    if (0 < t.length) {
                        var z = g._colorSet[r % g._colorSet.length],
                            w = g.lineColor = g.options.lineColor || z,
                            E = w;
                        f.fillStyle = z;
                        f.strokeStyle = w;
                        ...
                        var T = "solid";
                        if (f.setLineDash) {
                            var S = I(g.nullDataLineDashType, g.lineThickness),
                                T = g.lineDashType,
                                fa = I(T, g.lineThickness);
                            f.setLineDash(fa)
                        }
                        for (; r < t.length; r++)
                            if (y = t[r].x.getTime ? t[r].x.getTime() : t[r].x, !(y < a.axisX.dataInfo.viewPortMin ||
                                    y > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                var aa = u;
                                "number" !== typeof t[r].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(y), u = a.axisY.convertValueToPixel(t[r].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || T === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = u, m = n.x, u = n.y, b(), f.moveTo(n.x, n.y), m = d, u = c, D = n, T = g.nullDataLineDashType, f.setLineDash(S)), f.lineTo(m, aa), f.lineTo(m, u), v && (l.lineTo(m, aa), l.lineTo(m, u))) :
                                    (f.beginPath(), f.moveTo(m, u), v && (l.beginPath(), l.moveTo(m, u)), D = {
                                        x: m,
                                        y: u
                                    }), c = d = !1) : (f.lineTo(m, aa), v && l.lineTo(m, aa), f.lineTo(m, u), v && l.lineTo(m, u), 0 == r % 250 && b()), n = {
                                    x: m,
                                    y: u
                                }, r < t.length - 1 && (E !== (t[r].lineColor || w) || T !== (t[r].lineDashType || g.lineDashType)) && (b(), E = t[r].lineColor || w, f.strokeStyle = E, f.setLineDash && (t[r].lineDashType ? (T = t[r].lineDashType, f.setLineDash(I(T, g.lineThickness))) : (T = g.lineDashType, f.setLineDash(fa)))), y = g.dataPointIds[r], this._eventManager.objectMap[y] = {
                                    id: y,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: q,
                                    dataPointIndex: r,
                                    x1: m,
                                    y1: u
                                }, 0 !== t[r].markerSize && (0 < t[r].markerSize || 0 < g.markerSize) && (aa = g.getMarkerProperties(r, m, u, f), h.push(aa), y = O(y), v && h.push({
                                    x: m,
                                    y: u,
                                    ctx: l,
                                    type: aa.type,
                                ...
                                })), (t[r].indexLabel || g.indexLabel || t[r].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "stepArea",
                                    dataPoint: t[r],
                                    dataSeries: g,
                                    point: {
        ...
        m.prototype.renderStackedArea = function(a) {
            function d() {
                if (!(1 > k.length)) {
                    ...
                    b.globalAlpha = 1;
                    b.beginPath();
                    v && (m.closePath(), m.fill(), m.beginPath());
                    k = []
                }
            }
            var c = a.targetCanvasCtx || this.plotArea.ctx,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    if (0 < n.length) {
                        ...
                        x = "solid";
                        if (b.setLineDash) {
                            var S = I(z.nullDataLineDashType, z.lineThickness);
                            x = z.lineDashType;
                            var fa = I(x, z.lineThickness);
                            b.setLineDash(fa)
                        }
                        for (var aa = !0, q = 0; q < n.length; q++) {
                            var f = n[q],
                                ia = null,
                                ia = 0 <= z.dataPointIndexes[f] ? w[z.dataPointIndexes[f]] : {
                                    x: f,
                                    y: null
                                };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !aa)))
                                if ("number" !== typeof ia.y) z.connectNullData || (aa || y) || d(), aa = !0;
                                else {
                                    ...
                                    q < w.length - 1 && (T !== (w[q].lineColor || E) || x !== (w[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, t), k.push({
                                        x: g,
                                        y: r - oa
                                    }), T = w[q].lineColor || E, b.strokeStyle = T, b.setLineDash && (w[q].lineDashType ? (x = w[q].lineDashType, b.setLineDash(I(x, z.lineThickness))) : (x = z.lineDashType, b.setLineDash(fa))));
                                    if (0 <= z.dataPointIndexes[f]) {
                                        var A = z.dataPointIds[z.dataPointIndexes[f]];
                                    ...
                                    0 <= z.dataPointIndexes[f] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < z.markerSize) && (oa = z.getMarkerProperties(z.dataPointIndexes[f], g, t, b), l.push(oa), f = O(A), v && l.push({
                                        x: g,
                                        y: t,
                                        ctx: m,
                                        type: oa.type,
                                    ...
                                    (ia.indexLabel || z.indexLabel || ia.indexLabelFormatter || z.indexLabelFormatter) && this._indexLabels.push({
                ...
                v && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(s.x1,
                    s.y1, s.width, s.height), m.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
        ...
        m.prototype.renderStackedArea100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    p = [],
                    q = 0,
                    g, t, r, m, u, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                b.clip();
                v && (x.beginPath(), x.rect(l.x1, l.y1, l.width, l.height), x.clip());
                for (var e = [], B = 0; B < a.dataSeriesIndexes.length; B++) {
                    var D = a.dataSeriesIndexes[B],
                        z = this.data[D],
                        w = z.dataPoints;
                    z.dataPointIndexes = [];
                    for (q = 0; q < w.length; q++) D = w[q].x.getTime ? w[q].x.getTime() : w[q].x, z.dataPointIndexes[D] = q, e[D] || (n.push(D), e[D] = !0);
                    n.sort(Qa)
                }
                for (B = 0; B < a.dataSeriesIndexes.length; B++) {
                    D = a.dataSeriesIndexes[B];
                    ...
                    if (0 < n.length) {
                        ...
                        for (var aa = !0, q = 0; q < n.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !aa)))
                                if ("number" !== typeof ia.y) z.connectNullData || (aa || m) || d(), aa = !0;
                                else {
                                    var oa;
                                    oa = 0 !== a.dataPointYSums[f] ? 100 * (ia.y / a.dataPointYSums[f]) : 0;
                                    g = a.axisX.convertValueToPixel(f);
                                    var na = h[f] ? h[f] : 0;
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        p[f] = oa + (p[f] ? p[f] : 0);
                                    ...
                                    h[f] = y - t;
                                    m || aa ? (!m && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || u === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (m = k.pop(), u = k[k.length - 1], d(), b.moveTo(r.x, r.y), k.push(u), k.push(m), u = z.nullDataLineDashType,
                                        b.setLineDash(S)), b.lineTo(g, t), v && x.lineTo(g, t)) : (b.beginPath(), b.moveTo(g, t), v && (x.beginPath(), x.moveTo(g, t))), aa = m = !1) : (b.lineTo(g, t), v && x.lineTo(g, t), 0 == q % 250 && (d(), b.moveTo(g, t), v && x.moveTo(g, t), k.push({
                                        x: g,
                                        y: y - na
                                    })));
                                    r = {
                                    ...
                                    q < w.length - 1 && (T !== (w[q].lineColor || E) || u !== (w[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, t), k.push({
                                        x: g,
                                        y: y - na
                                    }), T = w[q].lineColor || E, b.strokeStyle = T, b.setLineDash && (w[q].lineDashType ? (u = w[q].lineDashType, b.setLineDash(I(u, z.lineThickness))) : (u =
                                        z.lineDashType, b.setLineDash(A))));
                                    if (0 <= z.dataPointIndexes[f]) {
                                    ...
                                    0 <= z.dataPointIndexes[f] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < z.markerSize) && (na = z.getMarkerProperties(q, g, t, b), s.push(na), f = O(G), v && s.push({
                                        x: g,
                                        y: t,
                                        ctx: x,
                                        type: na.type,
                                    ...
                                    (ia.indexLabel || z.indexLabel ||
                                        ia.indexLabelFormatter || z.indexLabelFormatter) && this._indexLabels.push({
                ...
                v && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas,
                    0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(l.x1, l.y1, l.width, l.height), x.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
        ...
        m.prototype.renderBubble = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var s = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
                    for (var n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints, g = 0, e = 0; e < q.length; e++) f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" ===
                        typeof q[e].z || (g = q[e].z, g > s && (s = g), g < h && (h = g));
                for (var t = 25 * Math.PI, r = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, t), k = 0; k < a.dataSeriesIndexes.length; k++)
                    if (n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints, 0 < q.length)
                        for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                            if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                                ...
                                var g = q[e].z,
                                    m = 2 * Math.max(Math.sqrt((s === h ? r / 2 : t + (r - t) / (s - h) * (g - h)) / Math.PI) << 0, 1),
                                    g = p.getMarkerProperties(e, c);
                                g.size = m;
                                c.globalAlpha = p.fillOpacity;
                                ba.drawMarker(f, l, c, g.type, g.size, g.color, g.borderColor, g.borderThickness);
                                c.globalAlpha = 1;
                                ...
                                m = O(u);
                                v && ba.drawMarker(f, l, this._eventManager.ghostCtx, g.type, g.size, m, m, g.borderThickness);
                                (q[e].indexLabel || p.indexLabel ||
                                    q[e].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "bubble",
                                    dataPoint: q[e],
                                    dataSeries: p,
                                    point: {
                        ...
                        for (var p = 0, q = 0, e = 0; e < n.length; e++)
                            if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                                ...
                                Math.sqrt((p - f) * (p - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (p = k.dataPointIds[e], this._eventManager.objectMap[p] = {
                                    ...
                                    x1: f,
                                    y1: l
                                }, p = O(p), v && ba.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness), (n[e].indexLabel || k.indexLabel || n[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "scatter",
                                    dataPoint: n[e],
                                    dataSeries: k,
                                    point: {
            ...
            function(a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    t = this.options.dataPointWidth ?
                        this.dataPointWidth : 0.7 * l.width * (a.axisX.logarithmic ? Math.log(t) / Math.log(a.axisX.range) : Math.abs(t) / Math.abs(a.axisX.range)) << 0;
                    ...
                    c.clip();
                    v && (b.beginPath(), b.rect(l.x1, l.y1, l.width,
                        l.height), b.clip());
                    for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                        var L = a.dataSeriesIndexes[m],
                            u = this.data[L],
                            y = u.dataPoints;
                        if (0 < y.length)
                            for (var x = 5 < t && u.bevelEnabled ? !0 : !1, s = 0; s < y.length; s++)
                                if (y[s].getTime ? g = y[s].x.getTime() : g = y[s].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(y[s].y) && y[s].y.length && "number" === typeof y[s].y[0] && "number" === typeof y[s].y[1] && "number" === typeof y[s].y[2] && "number" === typeof y[s].y[3]) {
                                    h = a.axisX.convertValueToPixel(g);
                                    k = a.axisY.convertValueToPixel(y[s].y[0]);
                                    n = a.axisY.convertValueToPixel(y[s].y[1]);
                                    ...
                                    var B = h - t / 2 << 0,
                                        ...
                                        z = Math.round(Math.max(1, 0.15 * t)),
                                        w = 0 === z % 2 ? 0 : 0.5,
                                        E = u.dataPointIds[s];
                                    this._eventManager.objectMap[E] = {
                                        id: E,
                                    ...
                                    "candlestick" === u.type ? (c.moveTo(h - w, n), c.lineTo(h - w, Math.min(k, q)), c.stroke(), c.moveTo(h - w, Math.max(k, q)), c.lineTo(h - w, p), c.stroke(), da(c, B, Math.min(k, q), D, Math.max(k, q), y[s].y[0] <= y[s].y[3] ? u.risingColor : f, z, e, x, x, !1, !1, u.fillOpacity), v && (e = O(E), b.strokeStyle = e, b.moveTo(h - w, n), b.lineTo(h - w, Math.min(k, q)), b.stroke(), b.moveTo(h - w, Math.max(k, q)), b.lineTo(h - w, p), b.stroke(), da(b, B, Math.min(k, q), D, Math.max(k, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (c.moveTo(h -
                                        w, n), c.lineTo(h - w, p), c.stroke(), c.beginPath(), c.moveTo(h, k), c.lineTo(B, k), c.stroke(), c.beginPath(), c.moveTo(h, q), c.lineTo(D, q), c.stroke(), v && (e = O(E), b.strokeStyle = e, b.moveTo(h - w, n), b.lineTo(h - w, p), b.stroke(), b.beginPath(), b.moveTo(h, k), b.lineTo(B, k), b.stroke(), b.beginPath(), b.moveTo(h, q), b.lineTo(D, q), b.stroke()));
                                    (y[s].indexLabel || u.indexLabel || y[s].indexLabelFormatter || u.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: u.type,
                                        dataPoint: y[s],
                                        dataSeries: u,
                                        point: {
        ...
        m.prototype.renderBoxAndWhisker = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    f = this.plotArea,
                    l = 0,
                    s, h, k, n, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                    l = this.options.dataPointMaxWidth ?
                    this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width,
                    t = a.axisX.dataInfo.minDiff;
                isFinite(t) || (t = 0.3 * Math.abs(a.axisX.range));
                t = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * f.width * (a.axisX.logarithmic ? Math.log(t) / Math.log(a.axisX.range) : Math.abs(t) / Math.abs(a.axisX.range)) << 0;
                ...
                for (var m = !1, m = !!a.axisY.reversed, L = 0; L < a.dataSeriesIndexes.length; L++) {
                    var u = a.dataSeriesIndexes[L],
                        y = this.data[u],
                        x = y.dataPoints;
                    if (0 < x.length)
                        for (var B = 5 < t && y.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++)
                            if (x[l].getTime ? g = x[l].x.getTime() : g = x[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) &&
                                !r(x[l].y) && x[l].y.length && "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] && "number" === typeof x[l].y[3] && "number" === typeof x[l].y[4] && 5 === x[l].y.length) {
                                ...
                                var D = s - t / 2 << 0,
                                    ...
                                    w = Math.round(Math.max(1,
                                        0.15 * t)),
                                    E = 0 === w % 2 ? 0 : 0.5,
                                    T = x[l].whiskerColor ? x[l].whiskerColor : x[l].color ? y.whiskerColor ? y.whiskerColor : x[l].color : y.whiskerColor ? y.whiskerColor : e,
                                    S = "number" === typeof x[l].whiskerThickness ? x[l].whiskerThickness : "number" === typeof y.options.whiskerThickness ? y.whiskerThickness : w,
                                    A = x[l].whiskerDashType ? x[l].whiskerDashType : y.whiskerDashType,
                                    aa = r(x[l].whiskerLength) ? r(y.options.whiskerLength) ? t : y.whiskerLength : x[l].whiskerLength,
                                    aa = "number" === typeof aa ? 0 >= aa ? 0 : aa >= t ? t : aa : "string" === typeof aa ? parseInt(aa) *
                                    t / 100 > t ? t : parseInt(aa) * t / 100 : t,
                                    ia = 1 === Math.round(S) % 2 ? 0.5 : 0,
                                    oa = x[l].stemColor ? x[l].stemColor : x[l].color ? y.stemColor ? y.stemColor : x[l].color : y.stemColor ? y.stemColor : e,
                                    na = "number" === typeof x[l].stemThickness ? x[l].stemThickness : "number" === typeof y.options.stemThickness ? y.stemThickness : w,
                                    G = 1 === Math.round(na) % 2 ? 0.5 : 0,
                                    F = x[l].stemDashType ? x[l].stemDashType : y.stemDashType,
                                    ...
                                    x[l].lineThickness : "number" === typeof y.options.lineThickness ? y.lineThickness : w,
                                    Q = x[l].lineDashType ? x[l].lineDashType : y.lineDashType,
                                ...
                                c.save();
                                0 < na && (c.beginPath(), c.strokeStyle = oa, c.lineWidth = na, c.setLineDash && c.setLineDash(I(F, na)), c.moveTo(s - G, k), c.lineTo(s - G, h), c.stroke(), c.moveTo(s - G, p), c.lineTo(s - G, n), c.stroke());
                                c.restore();
                                b.lineWidth = Math.max(w, 4);
                                c.beginPath();
                                da(c, D, Math.min(q, k), z, Math.max(k, q), U, 0, e, m ? B : !1, m ? !1 : B, !1, !1, ua);
                                c.beginPath();
                                da(c, D, Math.min(n, q), z, Math.max(q, n), P, 0, e, m ? !1 : B, m ? B : !1, !1, !1, ua);
                                c.beginPath();
                                c.lineWidth = w;
                                c.strokeStyle = e;
                                c.rect(D - E, Math.min(k, n) - E, z - D + 2 * E, Math.max(k,
                                    n) - Math.min(k, n) + 2 * E);
                                c.stroke();
                                c.save();
                                0 < J && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(I(Q, J)), c.strokeStyle = K, c.lineWidth = J, c.moveTo(D, q - M), c.lineTo(z, q - M), c.stroke());
                                c.restore();
                                c.save();
                                0 < S && (c.beginPath(), c.setLineDash && c.setLineDash(I(A, S)), c.strokeStyle = T, c.lineWidth = S, c.moveTo(s - aa / 2 << 0, p - ia), c.lineTo(s + aa / 2 << 0, p - ia), c.stroke(), c.moveTo(s - aa / 2 << 0, h + ia), c.lineTo(s + aa / 2 << 0, h + ia), c.stroke());
                                c.restore();
                                v && (e = O(R), b.strokeStyle = e, b.lineWidth = na, 0 < na && (b.moveTo(s - E - G, k), b.lineTo(s -
                                    E - G, Math.max(h, p)), b.stroke(), b.moveTo(s - E - G, Math.min(h, p)), b.lineTo(s - E - G, n), b.stroke()), da(b, D, Math.max(k, n), z, Math.min(k, n), e, 0, null, !1, !1, !1, !1), 0 < S && (b.beginPath(), b.lineWidth = S, b.moveTo(s + aa / 2, p - ia), b.lineTo(s - aa / 2, p - ia), b.stroke(), b.moveTo(s + aa / 2, h + ia), b.lineTo(s - aa / 2, h + ia), b.stroke()));
                                (x[l].indexLabel || y.indexLabel || x[l].indexLabelFormatter || y.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: y.type,
                                    dataPoint: x[l],
                                    dataSeries: y,
                                    point: {
        ...
        m.prototype.renderRangeColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    l, s, h, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var p = a.dataSeriesIndexes[n],
                        ...
                        g = q.dataPoints;
                    if (0 < g.length)
                        for (var t = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
                            if (g[f].getTime ? h = g[f].x.getTime() : h = g[f].x, !(h < a.axisX.dataInfo.viewPortMin ||
                                ...
                                var m = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + n) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount + n) * k << 0,
                                    L = a.axisX.reversed ? m - k << 0 : m + k << 0,
                                ...
                                da(c, a.axisX.reversed ? L : m, l, a.axisX.reversed ? m : L, s, b, 0, b, t, t, !1, !1, q.fillOpacity);
                                b = O(u);
                                v && da(this._eventManager.ghostCtx, a.axisX.reversed ? L : m, l, a.axisX.reversed ? m : L, s, b, 0, null, !1, !1, !1, !1);
                ...
                v && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas &&
        ...
        m.prototype.renderError = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    l = this.plotArea,
                    s = 0,
                    h, k, n, p, q, g, t, m = a.axisX.dataInfo.minDiff;
                ...
                c.rect(l.x1, l.y1, l.width, l.height);
                c.clip();
                v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(l.x1, l.y1, l.width,
                    l.height), this._eventManager.ghostCtx.clip());
                for (var L = 0, u = 0; u < this.data.length; u++) !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && L || L++;
                for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                    var x = a.dataSeriesIndexes[y],
                        B = this.data[x],
                        D = B.dataPoints,
                        z = r(B._linkedSeries) ? !1 : B._linkedSeries.type.match(/(bar|column)/ig) && B._linkedSeries.visible ? !0 : !1,
                        w = 0;
                    if (z)
                        for (e = B._linkedSeries.id, u = 0; u < e; u++) !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible ||
                            this.data[u].type.match(/(stacked)/ig) && w || (this.data[u].type.match(/(range)/ig) && (f = !0), w++);
                    e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                    s = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? L : 1))) << 0 : 0.3 * this.width;
                    f && (s = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 *
                        this.height, 0.9 * (this.plotArea.height / (z ? L : 1))) << 0 : 0.03 * this.width);
                    u = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) / (z ? L : 1)) << 0;
                    this.dataPointMaxWidth && e > s && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, s));
                    !this.dataPointMaxWidth && (this.dataPointMinWidth && s < e) && (s = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e));
                    u < e && (u = e);
                    u > s && (u =
                        s);
                    if (0 < D.length)
                        for (var E = B._colorSet, s = 0; s < D.length; s++) {
                            var e = B.lineColor = B.options.color ? B.options.color : E[0],
                                T = {
                                    color: D[s].whiskerColor ? D[s].whiskerColor : D[s].color ? B.whiskerColor ? B.whiskerColor : D[s].color : B.whiskerColor ? B.whiskerColor : e,
                                    thickness: r(D[s].whiskerThickness) ? B.whiskerThickness : D[s].whiskerThickness,
                                    dashType: D[s].whiskerDashType ? D[s].whiskerDashType : B.whiskerDashType,
                                    length: r(D[s].whiskerLength) ? r(B.options.whiskerLength) ? u : B.options.whiskerLength : D[s].whiskerLength,
                                    trimLength: r(D[s].whiskerLength) ?
                                        r(B.options.whiskerLength) ? 50 : 0 : 0
                                };
                            ...
                            var S = {
                                color: D[s].stemColor ? D[s].stemColor : D[s].color ? B.stemColor ? B.stemColor : D[s].color : B.stemColor ? B.stemColor : e,
                                thickness: D[s].stemThickness ? D[s].stemThickness : B.stemThickness,
                                dashType: D[s].stemDashType ? D[s].stemDashType : B.stemDashType
                            };
                            S.thickness = "number" === typeof S.thickness ? 0 > S.thickness ? 0 : Math.round(S.thickness) : 2;
                            D[s].getTime ? t = D[s].x.getTime() : t = D[s].x;
                            if (!(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax) && !r(D[s].y) && D[s].y.length && "number" === typeof D[s].y[0] && "number" === typeof D[s].y[1]) {
                                var fa = a.axisX.convertValueToPixel(t);
                                b ? k = fa : h = fa;
                                fa = a.axisY.convertValueToPixel(D[s].y[0]);
                                b ? n = fa : q = fa;
                                fa = a.axisY.convertValueToPixel(D[s].y[1]);
                                b ? p = fa : g = fa;
                                b ? (q = a.axisX.reversed ? k + (z ? L : 1) * u / 2 - (z ? w - 1 : 0) * u <<
                                    0 : k - (z ? L : 1) * u / 2 + (z ? w - 1 : 0) * u << 0, g = a.axisX.reversed ? q - u << 0 : q + u << 0) : (n = a.axisX.reversed ? h + (z ? L : 1) * u / 2 - (z ? w - 1 : 0) * u << 0 : h - (z ? L : 1) * u / 2 + (z ? w - 1 : 0) * u << 0, p = a.axisX.reversed ? n - u << 0 : n + u << 0);
                                !b && q > g && (fa = q, q = g, g = fa);
                                b && n > p && (fa = n, n = p, p = fa);
                                fa = B.dataPointIds[s];
                                ...
                                A(c, Math.min(n, p), Math.min(q, g), Math.max(p,
                                    n), Math.max(g, q), e, T, S, b);
                                v && A(this._eventManager.ghostCtx, n, q, p, g, e, T, S, b);
                                if (D[s].indexLabel || B.indexLabel || D[s].indexLabelFormatter || B.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "error",
                                    dataPoint: D[s],
                                    dataSeries: B,
                                    indexKeyword: 0,
                                    point: {
                                        x: b ? D[s].y[1] >= D[s].y[0] ? n : p : n + (p - n) / 2,
                                        y: b ? q + (g - q) / 2 : D[s].y[1] >= D[s].y[0] ? g : q
                                    },
                                    direction: D[s].y[1] >= D[s].y[0] ? -1 : 1,
                                    bounds: {
                                        x1: b ? Math.min(n, p) : n,
                                        y1: b ? q : Math.min(q, g),
                                        x2: b ? Math.max(n, p) : p,
                                    ...
                                    indexKeyword: 1,
                                    point: {
                                        x: b ? D[s].y[1] >= D[s].y[0] ? p : n : n + (p - n) / 2,
                                        y: b ? q + (g - q) / 2 : D[s].y[1] >= D[s].y[0] ? q : g
                                    },
                                    direction: D[s].y[1] >= D[s].y[0] ? 1 : -1,
                                    bounds: {
                                        x1: b ? Math.min(n, p) : n,
        ...
        m.prototype.renderRangeBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b =
                    ...
                    e = this.plotArea,
                    f = 0,
                    l, s, h, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < t.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (f = 0; f < t.length; f++)
                            if (t[f].getTime ? k = t[f].x.getTime() : k = t[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(t[f].y) && t[f].y.length && "number" === typeof t[f].y[0] && "number" === typeof t[f].y[1]) {
                                ...
                                var L = a.axisX.reversed ? h - n << 0 : h + n << 0;
                                l > s && (b = l, l = s, s = b);
                                b = t[f].color ? t[f].color : g._colorSet[f % g._colorSet.length];
                                da(c, l, a.axisX.reversed ? L : h, s, a.axisX.reversed ? h : L, b, 0, null, m, !1, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = O(b);
                                v && da(this._eventManager.ghostCtx, l, a.axisX.reversed ? L : h, s, a.axisX.reversed ? h : L, b, 0, null, !1, !1, !1, !1);
                                if (t[f].indexLabel || g.indexLabel || t[f].indexLabelFormatter || g.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "rangeBar",
                                    dataPoint: t[f],
                                    dataSeries: g,
                                    indexKeyword: 0,
        ...
        m.prototype.renderRangeArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                b.clip();
                v && (e.beginPath(),
                    e.rect(l.x1, l.y1, l.width, l.height), e.clip());
                for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                    var h = [],
                    ...
                    if (0 < p.length) {
                        ...
                        var z = "solid";
                        if (b.setLineDash) {
                            var E = I(n.nullDataLineDashType,
                                    n.lineThickness),
                                z = n.lineDashType,
                                A = I(z, n.lineThickness);
                            b.setLineDash(A)
                        }
                        for (var T = !0; g < p.length; g++)
                            if (u = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !T)))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    q || T ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType ||
                                        z === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = A, z = n.nullDataLineDashType, b.setLineDash(E)), b.lineTo(t, r), v && e.lineTo(t, r), h.push({
                                        x: t,
                                        y1: r,
                                        y2: m
                                    })) : (b.beginPath(), b.moveTo(t, r), y = {
                                        x: t,
                                        y: r
                                    }, h = [], h.push({
                                        x: t,
                                        y1: r,
                                        y2: m
                                    }), v && (e.beginPath(), e.moveTo(t, r))), T = q = !1) : (b.lineTo(t, r), h.push({
                                        x: t,
                                        y1: r,
                                        y2: m
                                    }), v && e.lineTo(t, r), 0 == g % 250 && d());
                                    u = n.dataPointIds[g];
                                    this._eventManager.objectMap[u] = {
                                        id: u,
                                        objectType: "dataPoint",
                                    ...
                                    g < p.length - 1 && (w !== (p[g].lineColor || B) || z !== (p[g].lineDashType || n.lineDashType)) && (d(), w = p[g].lineColor || B, h[h.length - 1].newStrokeStyle = w, b.strokeStyle = w, b.setLineDash && (p[g].lineDashType ? (z = p[g].lineDashType, h[h.length - 1].newLineDashArray = I(z, n.lineThickness), b.setLineDash(h[h.length - 1].newLineDashArray)) : (z = n.lineDashType, h[h.length - 1].newLineDashArray = A, b.setLineDash(A))));
                                    if (0 !== p[g].markerSize && (0 < p[g].markerSize || 0 < n.markerSize)) {
                                        var S = n.getMarkerProperties(g, t, m, b);
                                        f.push(S);
                                        var fa = O(u);
                                        v && f.push({
                                            x: t,
                                        ...
                                        S = n.getMarkerProperties(g, t, r, b);
                                        f.push(S);
                                        fa = O(u);
                                        v && f.push({
                                            x: t,
                ...
                v && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx &&
                    this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(l.x1, l.y1, l.width, l.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
        ...
        m.prototype.renderRangeSplineArea = function(a) {
            function d(a, c) {
                ...
                if (0 < d.length) {
                    ...
                    for (f = d.length - 1; 2 < f; f -= 3) b.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y), v && e.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y);
                    b.closePath();
                        ...
                        for (g = !1; p < n.length; p++)
                            if (q = n[p].x.getTime ? n[p].x.getTime() :
                                ...
                                if (null !== n[p].y && n[p].y.length && "number" === typeof n[p].y[0] && "number" === typeof n[p].y[1]) {
                                    ...
                                    t = a.axisY.convertValueToPixel(n[p].y[1]);
                                    ...
                                    p < n.length - 1 && (x !==
                                        (n[p].lineColor || y) || B !== (n[p].lineDashType || k.lineDashType)) && (x = n[p].lineColor || y, r[r.length - 1].newStrokeStyle = x, b.setLineDash && (n[p].lineDashType ? (B = n[p].lineDashType, r[r.length - 1].newLineDashArray = I(B, k.lineThickness)) : (B = k.lineDashType, r[r.length - 1].newLineDashArray = D)));
                                    if (0 !== n[p].markerSize && (0 < n[p].markerSize || 0 < k.markerSize)) {
                                        var A = k.getMarkerProperties(p, q, g, b);
                                        f.push(A);
                                        var T = O(E);
                                        v && f.push({
                                            x: q,
                                        ...
                                        A = k.getMarkerProperties(p, q, t, b);
                                        f.push(A);
                                        T = O(E);
                                        v && f.push({
                                            x: q,
                                    ...
                                    g = !1
                                } else 0 < p && !g && (k.connectNullData ? b.setLineDash && (0 < r.length && (k.options.nullDataLineDashType || !n[p - 1].lineDashType)) && (r[r.length - 1].newLineDashArray = z, B = k.nullDataLineDashType) : (d(D, y), r = [], m = [])), g = !0;
                        d(D, y);
                        ba.drawMarkers(f)
                    }
                }
                v && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas,
                    0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(l.x1, l.y1, l.width, l.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
        ...
        m.prototype.renderWaterfall = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx,
                    ...
                    f = this.plotArea,
                    l = 0,
                    s, h, k, n, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                this.dataPointMaxWidth && l > h && (l = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, h));
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    var u = "number" === typeof r.options.lineThickness ? Math.round(r.lineThickness) : 1,
                        ...
                        2 ? -0.5 : 0;
                    if (0 < m.length)
                        for (var x = 5 < q && r.bevelEnabled ? !0 : !1, B = !1, w = null, z = null, l = 0; l < m.length; l++)
                            if (m[l].getTime ? n = m[l].x.getTime() : n = m[l].x, "number" !== typeof m[l].y) {
                                if (0 < l && !B && r.connectNullData) var E = r.options.nullDataLineDashType || !m[l - 1].lineDashType ? r.nullDataLineDashType : m[l - 1].lineDashType;
                                B = !0
                            } else {
                                ...
                                s = a.axisX.reversed ? s + a.plotType.totalDataSeries * q / 2 - (a.previousDataSeriesCount + g) * q << 0 : s - a.plotType.totalDataSeries * q / 2 + (a.previousDataSeriesCount + g) * q << 0;
                                var A = a.axisX.reversed ? s - q << 0 : s + q << 0;
                                h > k && (e = h, h = k, k = e);
                                ...
                                var T = m[l].color ? m[l].color : 0 < m[l].y ? r.risingColor : r.fallingColor;
                                da(c, a.axisX.reversed ? A : s, a.axisY.reversed ? k : h, a.axisX.reversed ?
                                    s : A, a.axisY.reversed ? h : k, T, 0, T, x, x, !1, !1, r.fillOpacity);
                                e = O(e);
                                v && da(this._eventManager.ghostCtx, a.axisX.reversed ? A : s, h, a.axisX.reversed ? s : A, k, e, 0, null, !1, !1, !1, !1);
                                var S, T = s;
                                ...
                                0 < l && w && (!B || r.connectNullData) && (B && c.setLineDash && c.setLineDash(I(E, u)), c.beginPath(), c.moveTo(w, z - y), c.lineTo(T, S - y), 0 < u && c.stroke(), v && (b.beginPath(), b.moveTo(w,
                                    z - y), b.lineTo(T, S - y), 0 < u && b.stroke()));
                                B = !1;
                                w = A;
                                z = 0 < m[l].y ? h : k;
                                T = m[l].lineDashType ? m[l].lineDashType : r.options.lineDashType ? r.options.lineDashType : "shortDash";
                                c.strokeStyle = m[l].lineColor ? m[l].lineColor : r.options.lineColor ? r.options.lineColor : "#9e9e9e";
                                c.lineWidth = u;
                                c.setLineDash && (T = I(T, u), c.setLineDash(T));
                                (m[l].indexLabel || r.indexLabel || m[l].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "waterfall",
                                    dataPoint: m[l],
                                    dataSeries: r,
                                    point: {
        ...
        var ra = function(a, d, c, b, e, f, l, h, r) {
            if (!(0 > c)) {
                ...
                a.save();
                a.globalAlpha = h;
                "pie" === e ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, c, f, l, !1), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth =
                    2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, l, !1), 0 <= r && a.arc(d.x, d.y, r * c, l, f, !0), a.closePath(), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
                a.globalAlpha = 1;
                a.restore()
            }
        };
        m.prototype.renderPie = function(a) {
                ...
                if (k && n) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                        ...
                        var h = g[e],
                            ...
                            s = null,
                            p = m.getPercentAndTotal(k,
                                f);
                        if (k.indexLabelFormatter || f.indexLabelFormatter) s = {
                            chart: m.options,
                            dataSeries: k,
                            dataPoint: f,
                            total: p.total,
                        ...
                        p = f.indexLabelFormatter ? f.indexLabelFormatter(s) : f.indexLabel ? m.replaceKeywordsWithValue(f.indexLabel, f, k, e) : k.indexLabelFormatter ? k.indexLabelFormatter(s) : k.indexLabel ? m.replaceKeywordsWithValue(k.indexLabel, f, k, e) : f.label ? f.label : "";
                        ...
                        h.endAngle = h.startAngle + 2 * Math.PI / B * Math.abs(f.y);
            ...
            function c(a) {
                ...
                for (b = 0; b < n.length; b++) {
                    ...
                    if (d > c) {
                        ...
                        ra(m.plotArea.ctx, g[b].center, g[b].radius, n[b].color ? n[b].color : k._colorSet[b % k._colorSet.length], k.type, c, d, k.fillOpacity, g[b].percentInnerRadius)
                    }
                }
                a = m.plotArea.ctx;
                a.save();
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < n.length) {
                    ...
                    k = 0;
                    k = "right" === p.hemisphere ? x.x + Math.sqrt(Math.pow(v, 2) - Math.pow(c - x.y, 2)) : x.x - Math.sqrt(Math.pow(v, 2) - Math.pow(c - x.y, 2));
                    s = x.x + z * Math.cos(p.midAngle);
                    q = x.y + z * Math.sin(p.midAngle);
                    q = Math.sqrt(Math.pow(k - s, 2) + Math.pow(c - q, 2));
                    s = Math.acos(z / v);
                    q = Math.acos((v * v + z * z - q * q) / (2 * z * v));
                    ...
                    q = e(a);
                    h = k = 0;
                    0 > c ? (h = "right" === p.hemisphere ? s : q, l = c, null !== h && (s = -c, c = p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 - (g[h].indexLabelTextBlock.y + g[h].indexLabelTextBlock.height /
                        2), c - s < t && (k = -s, h = f(h, k, d + 1), +h.toFixed(y) > +k.toFixed(y) && (l = c > t ? -(c - t) : -(s - (h - k)))))) : 0 < c && (h = "right" === p.hemisphere ? q : s, l = c, null !== h && (s = c, c = g[h].indexLabelTextBlock.y - g[h].indexLabelTextBlock.height / 2 - (p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2), c - s < t && (k = s, h = f(h, k, d + 1), +h.toFixed(y) < +k.toFixed(y) && (l = c > t ? c - t : s - (k - h)))));
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    ...
                    if ("inside" !== k.indexLabelPlacement) {
                        ...
                        for (a = 0; a < n.length; a++) {
                            var h = g[a];
                            h.indexLabelTextBlock.x = x.x + v * Math.cos(h.midAngle);
                            h.indexLabelTextBlock.y = x.y + v * Math.sin(h.midAngle);
                        ...
                        for (var s, r, a = 0; a < n.length; a++) {
                            ...
                            if (null !== u) {
                                ...
                                var B = 0,
                                    B = b(s, r) - t;
                                if (0 > B) {
                                    for (var D = r = 0, F = 0; F < n.length; F++) F !== a && g[F].hemisphere === h.hemisphere && (g[F].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? r++ :
                                        D++);
                                    r = B / (r + D || 1) * D;
                                    var D = -1 * (B - r),
                                        I = F = 0;
                                    "right" === h.hemisphere ? (F = f(a, r), D = -1 * (B - F), I = f(u, D), +I.toFixed(y) < +D.toFixed(y) && +F.toFixed(y) <= +r.toFixed(y) && f(a, -(D - I))) : (F = f(u, r), D = -1 * (B - F), I = f(a, D), +I.toFixed(y) < +D.toFixed(y) && +F.toFixed(y) <= +r.toFixed(y) && f(u, -(D - I)))
                                }
                            }
                        }
                    } else
                        for (a = 0; a < n.length; a++) h = g[a], v = "pie" === k.type ? 0.7 * z : 0.8 * z, u = x.x + v * Math.cos(h.midAngle), r = x.y + v * Math.sin(h.midAngle), h.indexLabelTextBlock.x = u, h.indexLabelTextBlock.y = r;
                    for (a = 0; a < n.length; a++)
                        if (h = g[a], u = h.indexLabelTextBlock.measureText(),
                            ...
                            x.x) < z && (u /= Math.abs(Math.sin(h.indexLabelAngle)), 9 < u && (u *= 0.3), u > d && (d = u)));
                            ...
                            if (f = !1, s = g[k], s.indexLabelText) {
                                ...
                                if (null !== l) {
                                    ...
                                    if (q = 0 > B) {
                                        ...
                                        var r = s.indexLabelTextBlock.y - s.indexLabelTextBlock.height / 2,
                                        ...
                                        q = s.indexLabelTextBlock.x + s.indexLabelTextBlock.width < h.indexLabelTextBlock.x - p || q > u + p || r > C + p || m < t - p ? !1 : !0
                                    }
                                    q ? (0 > a && (a = k), l !== a && (c = l, d += -B), 0 === k % Math.max(n.length /
                                        10, 3) && (f = !0)) : f = !0;
            ...
            function h() {
                ...
                m.legend && (m.legend.dockInsidePlotArea || "center" === m.legend.horizontalAlign && "center" ===
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var k = this.data[a.dataSeriesIndexes[0]],
                    ...
                    B = 0;
                a = !1;
                for (var D = 0; D < n.length; D++) B += Math.abs(n[D].y), !a && ("undefined" !== typeof n[D].indexLabel && null !== n[D].indexLabel && 0 < n[D].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof n[D].label && null !== n[D].label &&
                ...
                if (0 !== B) {
                    ...
                    k.radius && (z = Sa(k.radius, z));
                    var E = "undefined" !== typeof k.innerRadius && null !== k.innerRadius ? Sa(k.innerRadius, z) : 0.7 * z;
                    k.radius = z;
                    "doughnut" === k.type && (k.innerRadius = E);
                    var A = Math.min(E / z, (z - 1) / z);
                    this.pieDoughnutClickHandler = function(a) {
                        m.isAnimating ||
                            !r(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && m._animator.animate(0, 500, function(a) {
                                c(a);
                                h();
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                        ...
                        for (var b = g[0].startAngle + 2 * Math.PI * a, c = 0; c < n.length; c++) {
                            ...
                            e > d && ra(m.plotArea.ctx, g[c].center, g[c].radius, l, k.type, d, e, k.fillOpacity, g[c].percentInnerRadius);
                            if (f) break
                        }
                        h();
                        m.dispatchEvent("dataAnimationIterationEnd", {
                        ...
                        m.disableToolTip = !1;
                        m._animator.animate(0,
                            m.animatedRender ? 500 : 0,
                            function(a) {
                                c(a);
                                h();
                                m.dispatchEvent("dataAnimationIterationEnd", {
        ...
        m.prototype.renderFunnel = function(a) {
            ...
            function c() {
                ...
                if (0 === g) return -1;
                for (var l = d[0] = 0, h = 0, n, p, b = b - a, l = !1, k = 0; k < y.length; k++) a = Math.abs(y[k].y) * f / g, l ? n = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = ca * ca * b * b - 4 * Math.abs(ca) * a, 0 > p ? (p = c, l = (b + p) * (e - h) / 2, a -= l, n = e - h, h += e - h, n += 0 == p ? 0 : a / p, h += a / p, l = !0) : (n = (Math.abs(ca) * b - Math.sqrt(p)) / 2, p = b - 2 * n / Math.abs(ca), h += n, h > e && (h -= n, p = c, l = (b + p) * (e - h) / 2, a -= l, n = e - h, h += e - h, n += a / p, h += a / p, l = !0),
                    b = p)), d.push(n);
                return d
            }
            ...
            function b() {
                if (u && y) {
                    for (var a, b, c, d, e, f, k, l, h, n, p, q, s, m, t, C = [], x = [], B = {
                            percent: null,
                            total: null
                        }, w = null, z = 0; z < y.length; z++) t = R[z], t = "undefined" !== typeof t.x5 ? (t.y2 + t.y4) / 2 : (t.y2 + t.y3) / 2, t = g(t).x2 + 1, C[z] = J - t - X;
                    t = 0.5 * X;
                    for (var z = 0, D = y.length - 1; z < y.length || 0 <= D; z++, D--) {
                        b = u.reversed ? y[D] : y[z];
                        a = b.color ? b.color : u.reversed ? u._colorSet[(y.length - 1 - z) % u._colorSet.length] : u._colorSet[z % u._colorSet.length];
                        c = b.indexLabelPlacement || u.indexLabelPlacement || "outside";
                        m = b.indexLabelTextAlign ||
                            u.indexLabelTextAlign || "left";
                        d = b.indexLabelBackgroundColor || u.indexLabelBackgroundColor || (v ? "transparent" : null);
                        ...
                        s = u.dataPointIds[z];
                        L._eventManager.objectMap[s] = {
                            id: s,
                            objectType: "dataPoint",
                            dataPointIndex: z,
                            dataSeriesIndex: 0,
                            funnelSection: R[u.reversed ? y.length - 1 - z : z]
                        };
                        "inside" === u.indexLabelPlacement && (C[z] = z !== da ? u.reversed ? R[z].x2 - R[z].x1 :
                            R[z].x3 - R[z].x4 : R[z].x3 - R[z].x6, 20 > C[z] && (C[z] = z !== da ? u.reversed ? R[z].x3 - R[z].x4 : R[z].x2 - R[z].x1 : R[z].x2 - R[z].x1, C[z] /= 2));
                        s = b.indexLabelMaxWidth ? b.indexLabelMaxWidth : u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth : C[z];
                        if (s > C[z] || 0 > s) s = C[z];
                        x[z] = "inside" === u.indexLabelPlacement ? R[z].height : !1;
                        B = L.getPercentAndTotal(u, b);
                        if (u.indexLabelFormatter || b.indexLabelFormatter) w = {
                            chart: L.options,
                            dataSeries: u,
                            dataPoint: b,
                            total: B.total,
                        ...
                        b = b.indexLabelFormatter ? b.indexLabelFormatter(w) : b.indexLabel ?
                            L.replaceKeywordsWithValue(b.indexLabel, b, u, z) : u.indexLabelFormatter ? u.indexLabelFormatter(w) : u.indexLabel ? L.replaceKeywordsWithValue(u.indexLabel, b, u, z) : b.label ? b.label : "";
                        0 >= n && (n = 0);
                        1E3 > s && 1E3 - s < t && (s += 1E3 - s);
                        P.roundRect || Ca(P);
                        c = new ka(P, {
                            fontSize: f,
                            fontFamily: l,
                            ...
                            backgroundColor: d,
                            maxWidth: s,
                            maxHeight: !1 === x[z] ? q ? 4.28571429 * f : 1.5 * f : x[z],
                            text: b,
                            padding: ea
                        });
                        c.measureText();
            ...
            function e() {
                ...
                e = !1;
                c = 0;
                for (var g, k = J - $ - X / 2, k = u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth > k ? k : u.indexLabelMaxWidth : k, l = H.length - 1; 0 <= l; l--) {
                    g = y[H[l].id];
                    c = H[l];
                    d = c.textBlock;
                ...
                if (e)
                    for (l = H.length - 1; 0 <= l; l--) a = R[l], H[l].textBlock.maxWidth =
                        ...
                        (H[l].textBlock.y < pa - B && (H[l].textBlock.y = pa - B), H[l].textBlock.y + H[l].height > ua + B && (H[l].textBlock.y = ua + B - H[l].height))
            }

            function f() {
                var a, b, c, d;
                if ("inside" !== u.indexLabelPlacement)
                    for (var e = 0; e < R.length; e++) 0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = R[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = u.reversed ? "undefined" !== typeof a.x5 ? c > Y ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < Y ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, H[e].textBlock.x = b + X, H[e].textBlock.y =
                        c - H[e].height / 2, u.reversed ? (H[e].textBlock.y + H[e].height > pa + B && (H[e].textBlock.y = pa + B - H[e].height), H[e].textBlock.y < ua - B && (H[e].textBlock.y = ua - B)) : (H[e].textBlock.y < pa - B && (H[e].textBlock.y = pa - B), H[e].textBlock.y + H[e].height > ua + B && (H[e].textBlock.y = ua + B - H[e].height)));
                else
                    for (e = 0; e < R.length; e++) 0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = R[e], b = a.height, c = H[e].height, d = H[e].width, b >= c ? (b = e != da ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2, c = e != da ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, H[e].textBlock.x = b,
            ...
            function l() {
                ...
                function b() {
                    ...
                    for (var k, h = 1; h < l; h++) {
                        e = h * f;
                        for (var s = H.length - 1; 0 <= s; s--) !H[s].isDirty && (H[s].textBlock.y <
                            e && H[s].textBlock.y + H[s].height > e) && (k = q(s), !(k >= H.length - 1) && H[s].textBlock.y + H[s].height + ea > H[k].textBlock.y && (H[s].textBlock.y = H[s].textBlock.y + H[s].height - e > e - H[s].textBlock.y ? e + 1 : e - H[s].height - 1))
                    }
                    for (k = R.length - 1; 0 < k; k--)
                        if (!H[k].isDirty) {
                            ...
                            if (H[k].textBlock.y < H[e].textBlock.y + H[e].height) {
                                d = d || k;
                                f = k;
                                for (l = 0; H[f].textBlock.y < H[e].textBlock.y + H[e].height + ea;) {
                ...
                for (var d, e, f, g, l, k, n = 1, r = 0; r < 2 * n; r++) {
                    for (var m = H.length - 1; 0 <= m && !(0 <= p(m) && p(m), f = H[m], g = f.textBlock,
                            k = (l = q(m) < R.length ? H[q(m)] : null) ? l.textBlock : null, d = +f.height.toFixed(6), e = +g.y.toFixed(6), !f.isDirty && (l && e + d + ea > +k.y.toFixed(6)) && (d = g.y + d + ea - k.y, e = a(m, -d), e < d && (0 < e && (d -= e), e = a(q(m), d), e != d))); m--);
                    b()
                }
            }

            function h(a, b) {
                return (b < R.length ? H[b].textBlock.y : u.reversed ? pa + B : ua + B) - (0 > a ? u.reversed ? ua - B : pa - B : H[a].textBlock.y + H[a].height + ea)
            }
            ...
            function m(a, b, c) {
                ...
                if (0 === Z.length) l =
                    ...
                    e = B * (1 != Z.length || 0 != Z[0] && Z[0] != R.length - 1 ? 2 : 1) / k();
                    for (var s = 0; s < R.length; s++) {
                        ...
                        l.push(ja[s] + d);
                        if (0 <= Z.indexOf(s) || s < R.length && 0 <= Z.indexOf(s + 1)) d += e
                    }
                }
                g = function() {
                ...
                a._animator.animate(0, c, function(c) {
                    ...
                    w(d);
                    F && ("inside" !== u.indexLabelPlacement ? n(d) : f(), t(d));
                    1 <= c && (ha = !1)
            ...
            function w(a) {
                ...
                a.roundRect || Ca(a);
                L.title && (L.title.dockInsidePlotArea || "center" === L.title.horizontalAlign && "center" === L.title.verticalAlign) && (L.title.ctx = a, L.title.render());
                if (L.subtitles)
                    for (var b = 0; b < L.subtitles.length; b++) {
                        var c = L.subtitles[b];
                        if (c.dockInsidePlotArea || "center" === c.horizontalAlign && "center" === c.verticalAlign) L.subtitles.ctx =
                            a, c.render()
                    }
                L.legend && (L.legend.dockInsidePlotArea || "center" === L.legend.horizontalAlign && "center" === L.legend.verticalAlign) && (L.legend.ctx = a, L.legend.setLayout(), L.legend.render());
                U.fNg && U.fNg(L)
            }
            var L = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var u = this.data[a.dataSeriesIndexes[0]], y = u.dataPoints, x = this.plotArea, B = 0.025 * x.width, D = 0.01 * x.width, z = 0, E = x.height - 2 * B, A = Math.min(x.width - 2 * D, 2.8 * x.height), F = !1, S = 0; S < y.length; S++)
                    if (!F && ("undefined" !== typeof y[S].indexLabel && null !== y[S].indexLabel &&
                            0 < y[S].indexLabel.toString().length) && (F = !0), !F && ("undefined" !== typeof y[S].label && null !== y[S].label && 0 < y[S].label.toString().length) && (F = !0), !F && "function" === typeof u.indexLabelFormatter || "function" === typeof y[S].indexLabelFormatter) F = !0;
                F = F || "undefined" !== typeof u.indexLabel && null !== u.indexLabel && 0 < u.indexLabel.toString().length;
                "inside" !== u.indexLabelPlacement && F || (D = (x.width - 0.75 * A) / 2);
                var S = x.x1 + D,
                    J = x.x2 - D,
                    K = x.y1 + B,
                    Q = x.y2 - B,
                    P = a.targetCanvasCtx || this.plotArea.ctx || this.ctx;
                if (0 != u.length && (u.dataPoints &&
                        u.visible) && 0 !== y.length) {
                    var O, G;
                    a = 75 * A / 100;
                    var X = 30 * (J - a) / 100;
                    "funnel" === u.type ? (O = r(u.options.neckHeight) ? 0.35 * E : u.neckHeight, G = r(u.options.neckWidth) ? 0.25 * a : u.neckWidth, "string" === typeof O && O.match(/%$/) ? (O = parseInt(O), O = O * E / 100) : O = parseInt(O), "string" === typeof G && G.match(/%$/) ? (G = parseInt(G), G = G * a / 100) : G = parseInt(G), O > E ? O = E : 0 >= O && (O = 0), G > a ? G = a - 0.5 : 0 >= G && (G = 0)) : "pyramid" === u.type && (G = O = 0, u.reversed = u.reversed ? !1 : !0);
                    var D = S + a / 2,
                        V = S,
                        $ = S + a,
                        pa = u.reversed ? Q : K,
                    ...
                    if (-1 !== S) {
                        if (u.reversed)
                            for (A.push(W), G = S.length - 1; 0 < G; G--) W += S[G], A.push(W);
                        else
                            for (G = 0; G < S.length; G++) W += S[G], A.push(W);
                        if (u.reversed)
                            for (G = 0; G < S.length; G++) A[G] < Y ? (a.push(M), D.push(ba), da = G) : (a.push((A[G] - pa + ca * V) / ca), D.push((A[G] - pa + ga * $) / ga));
                        else
                            for (G = 0; G < S.length; G++) A[G] < Y ? (a.push((A[G] - pa + ca * V) / ca), D.push((A[G] - pa + ga * $) / ga), da = G) : (a.push(M), D.push(ba));
                        for (G = 0; G < S.length - 1; G++) W = u.reversed ? y[y.length - 1 - G].color ? y[y.length - 1 - G].color : u._colorSet[(y.length - 1 - G) % u._colorSet.length] : y[G].color ? y[G].color : u._colorSet[G % u._colorSet.length], G === da ? R.push({
                            x1: a[G],
                            y1: A[G],
                            x2: D[G],
                            y2: A[G],
                        ...
                        a = a = 0;
                        Da(Z);
                        for (G = 0; G < y.length; G++) y[G].exploded &&
                            (S = !0, u.reversed ? Z.push(y.length - 1 - G) : Z.push(G));
                        P.clearRect(x.x1, x.y1, x.width, x.height);
                        P.fillStyle = L.backgroundColor;
                        P.fillRect(x.x1, x.y1, x.width, x.height);
                        if (F && u.visible && (b(), f(), e(), "inside" !== u.indexLabelPlacement)) {
                            l();
                            for (G = 0; G < y.length; G++) H[G].isDirty || (a = H[G].textBlock.x + H[G].width, a = (J - a) / 2, 0 == G && (z = a), z > a && (z = a));
                            for (G = 0; G < R.length; G++) R[G].x1 += z, R[G].x2 += z, R[G].x3 += z, R[G].x4 += z, R[G].x5 && (R[G].x5 += z, R[G].x6 += z), H[G].textBlock.x += z
                        }
                        for (G = 0; G < R.length; G++) z = R[G], ta(P, z, u.fillOpacity),
                            ja.push(z.y1);
                        w(P);
                        F && u.visible && ("inside" === u.indexLabelPlacement || L.animationEnabled || n(P), L.animationEnabled || t());
                        if (!F)
                            for (G = 0; G < y.length; G++) z = u.dataPointIds[G], a = {
                                id: z,
                                objectType: "dataPoint",
                                dataPointIndex: G,
                                dataSeriesIndex: 0,
                                funnelSection: R[u.reversed ? y.length - 1 - G : G]
                            }, L._eventManager.objectMap[z] = a;
                        !L.animationEnabled && S ? m(L, -1, 0) : L.animationEnabled && !L.animatedRender && m(L, -1, 0);
                        this.funnelPyramidClickHandler = function(a) {
                            var b = -1;
                            if (!ha && !L.isAnimating && (r(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) &&
                                (b = u.reversed ? y.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) {
                                a = b;
                        ...
                        return {
                            ...
                            animationCallback: function(a, b) {
                                ...
                                1 <= a && (m(L, -1, 500), w(L.plotArea.ctx || L.ctx))
                            },
                            easingFunction: N.easing.easeInQuad,
                            animationBase: 0
                        }
        ...
        m.prototype.set = function(a, d, c) {
            ...
            "options" === a ? (this.options = d, c && this.render()) : m.base.set.call(this,
                a, d, c)
        };
        m.prototype.exportChart = function(a) {
            ...
            if (b && d && c) {
                ...
                if ("undefined" !== typeof Blob && new Blob) {
                    for (var l = b.replace(/^data:[a-z\/]*;base64,/, ""), l = atob(l), h = new ArrayBuffer(l.length), h = new Uint8Array(h), r = 0; r < l.length; r++) h[r] =
                        l.charCodeAt(r);
                    d = new Blob([h.buffer], {
                        type: "image/" + d
                    });
        ...
        m.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
            ...
            if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                ...
                do {
                    ...
                    a = a.replace("#percent", ha(l, r, f._cultureInfo));
                    a = a.replace("#total", ha(h, c.yValueFormatString ? c.yValueFormatString : "#,##0.########", f._cultureInfo))
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                g = null;
                if ("color" === a) return "waterfall" === c.type ? d.color ? d.color : 0 < d.y ? c.risingColor : c.fallingColor : "error" === c.type ? c.color ? c.color : c._colorSet[l % c._colorSet.length] :
                ...
                if ("x" === a)
                    if (c.axisX && "dateTime" === c.axisX.valueType || "dateTime" === c.xValueType || d.x && d.x.getTime) {
                        if (!c.axisX.logarithmic) return Ba(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = f.axisX && f.axisX.autoValueFormatString ? f.axisX.autoValueFormatString : "DD MMM YY", f._cultureInfo)
                    } else return ha(g,
                        d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = "#,##0.########", f._cultureInfo);
                else return "y" === a ? ha(g, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", f._cultureInfo) : "z" === a ? ha(g, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : c.zValueFormatString = "#,##0.########", f._cultureInfo) : g
            })
        };
        qa(P, W);
        P.prototype.setLayout = function() {
            ...
            var m = [],
                k = [];
            if ("top" === this.verticalAlign || "bottom" === this.verticalAlign) this.orientation = "horizontal", c = this.verticalAlign, f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width, l = this.maxHeight = null !== this.maxHeight ? this.maxHeight :
                0.5 * d.height;
            ...
            for (var n = 0; n < this.dataSeries.length; n++) {
                ...
                if (p.dataPoints && p.dataPoints.length)
                    if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !==
                        p.type && "pyramid" !== p.type) {
                        var q = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? "error" === p.type && p._linkedSeries ? p._linkedSeries.legendMarkerType ? p._linkedSeries.legendMarkerType : X.getDefaultLegendMarker(p._linkedSeries.type) : X.getDefaultLegendMarker(p.type) : p.markerType,
                            ...
                            t = p.legendMarkerColor = p.legendMarkerColor ? p.legendMarkerColor : p.markerColor ? p.markerColor : "error" === p.type ? r(p.whiskerColor) ? p._colorSet[0] : p.whiskerColor : p._colorSet[0],
                            ...
                            u = p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : p.markerBorderThickness ? Math.max(1, Math.round(0.2 * v)) : 0;
                        "error" ===
                        p.type && this.errorMarkerColor.push(t);
                        ...
                        for (var y = 0; y < p.dataPoints.length; y++) {
                            var x = p.dataPoints[y],
                                q = x.legendMarkerType ? x.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : X.getDefaultLegendMarker(p.type),
                                g = x.legendText ? x.legendText :
                                ...
                                t = x.legendMarkerColor ? x.legendMarkerColor : p.legendMarkerColor ? p.legendMarkerColor : x.color ? x.color : p.color ? p.color : p._colorSet[y % p._colorSet.length],
                                v = 0.75 * this.lineHeight,
                                w = x.legendMarkerBorderColor ? x.legendMarkerBorderColor : p.legendMarkerBorderColor ? p.legendMarkerBorderColor : x.markerBorderColor ? x.markerBorderColor : p.markerBorderColor,
                                u = x.legendMarkerBorderThickness ? x.legendMarkerBorderThickness : p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : x.markerBorderThickness || p.markerBorderThickness ? Math.max(1, Math.round(0.2 * v)) : 0,
                ...
                for (n = 0; n < m.length; n++) {
                    ...
                    if (!(0 >= l || "undefined" === typeof l || 0 >= w || "undefined" === typeof w)) {
                        if ("horizontal" ===
                            ...
                            if (!p || p.width +
                                Math.round(q.textBlock.width + v + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) p = {
                                items: [],
                                width: 0
                            ...
                            items: [],
                            width: 0
                        }, k.push(p)) : (p = k[y], y = (y + 1) % k.length), this.height += q.textBlock.height;
                        q.textBlock.x = p.width;
                        q.textBlock.y = 0;
                        p.width += Math.round(q.textBlock.width + v + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" ===
                            q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0));
                        p.items.push(q);
                        this.width = Math.max(p.width, this.width);
                        t = q.textBlock.width + (v + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))
                    }
                }
                this.itemWidth = t;
            ...
            this.items = m;
            for (n = 0; n < this.items.length; n++) q = m[n], q.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[q.id] = {
                id: q.id,
            ...
            for (var h = 0, r = 0; r < l.length; r++) {
                for (var k = l[r], n = 0, p = 0; p < k.items.length; p++) {
                    ...
                    if ("line" === q.chartType || "stepLine" === q.chartType ||
                        "spline" === q.chartType) this.ctx.strokeStyle = q.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, m + this.lineHeight / 2), this.ctx.lineTo(g + 0.85 * this.lineHeight, m + this.lineHeight / 2), this.ctx.stroke(), v -= 0.1 * this.lineHeight;
                    ...
                    this.ghostCtx.fillRect(v, q.textBlock.y - this.lineHeight / 2, q.textBlock.x + q.textBlock.width - v, q.textBlock.height);
        ...
        qa(X, W);
        X.prototype.getDefaultAxisPlacement = function() {
            var a = this.type;
        ...
        X.getDefaultLegendMarker = function(a) {
        ...
        X.prototype.getDataPointAtX = function(a, d) {
            ...
            var c = {
                ...
                k = 0,
                n = 0;
            "none" !== this.chart.plotInfo.axisPlacement && (this.axisX.logarithmic ? (n = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
                n = 1 < n ? Math.min(Math.max((this.dataPoints.length - 1) / n * Math.log(a / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (n = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, n = 0 < n ? Math.min(Math.max((this.dataPoints.length - 1) / n * (a - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0));
            for (;;) {
                f = 0 < l ? n + e : n - e;
        ...
        X.prototype.getDataPointAtXY = function(a, d, c) {
            ...
            if ("none" !== this.chart.plotInfo.axisPlacement)
                ...
                else q = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, p = 0 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * (p - this.dataPoints[0].x) >>
                        ...
                        switch (this.type) {
                            ...
                            case "doughnut":
                                ...
                                w = "doughnut" === this.type ? q.percentInnerRadius * q.radius :
                                    0;
                                m = Math.sqrt(Math.pow(v.x - a, 2) + Math.pow(v.y - d, 2));
                                m < q.radius && m > w && (m = Math.atan2(d - v.y, a - v.x), 0 > m && (m += 2 * Math.PI), m = Number(((180 * (m / Math.PI) % 360 + 360) % 360).toFixed(12)), v = Number(((180 * (q.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), w = Number(((180 * (q.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === w && 1 < q.endAngle && (w = 360), v >= w && 0 !== g.y && (w += 360, m < v && (m += 360)), m > v && m < w && (b.push({
                                    dataPoint: g,
                                    dataPointIndex: f,
                                    dataSeries: this,
                                    distance: 0
                            ...
                            case "pyramid":
                                m = q.funnelSection;
                                d > m.y1 && d < m.y4 && (m.y6 ? d > m.y6 ? (f = m.x6 + (m.x5 - m.x6) / (m.y5 - m.y6) * (d - m.y6), m = m.x3 + (m.x4 - m.x3) / (m.y4 - m.y3) * (d - m.y3)) : (f = m.x1 + (m.x6 - m.x1) / (m.y6 - m.y1) * (d - m.y1), m = m.x2 + (m.x3 - m.x2) / (m.y3 - m.y2) * (d - m.y2)) : (f = m.x1 + (m.x4 - m.x1) / (m.y4 - m.y1) * (d - m.y1), m = m.x2 + (m.x3 - m.x2) / (m.y3 - m.y2) * (d - m.y2)), a > f && a < m && (b.push({
                                    dataPoint: g,
                                    dataPointIndex: q.dataPointIndex,
                                    dataSeries: this,
                                    distance: 0
        ...
        X.prototype.getMarkerProperties = function(a, d, c, b) {
        ...
        E.prototype.createExtraLabelsForLog = function(a) {
            ...
            if (!(5 < a)) {
                ...
                if (Math.log(this.range) / Math.log(d / this.viewportMinimum) < this.noTicks - 1) {
                    for (var c = E.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length),
        ...
        E.prototype.createLabels = function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.logarithmic && !this.equidistantInterval)
                    for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, g = q; b < this.logLabelValues.length; b++)
                        if (c = this.logLabelValues[b], c < this.viewportMinimum) b++;
                            ...
                            a = g < p.length &&
                                c >= p[g].startValue && c <= p[g].endValue;
                            n = c;
                            ...
                            }) : "axisX" === this.type && this.labels[n] ? this.labels[n] : ha(n, this.valueFormatString, this.chart._cultureInfo), a = new ka(this.ctx, {
                                x: 0,
                                y: 0,
                                maxWidth: f,
                                maxHeight: l,
                ...
                for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType,
                    ...
                    a || (a = this.labelFormatter ? this.labelFormatter({
                            ...
                            value: new Date(n),
                            label: this.labels[n] ? this.labels[n] : null
                        }) : "axisX" === this.type && this.labels[n] ? this.labels[n] : Ba(n, this.valueFormatString, this.chart._cultureInfo),
                        a = new ka(this.ctx, {
                            x: 0,
                            y: 0,
                            maxWidth: f,
            ...
            if ("bottom" === this._position || "top" === this._position) h = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.width * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.width / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) *
                K[this.intervalType + "Duration"] * this.interval, f = "undefined" === typeof this.options.labelMaxWidth ? 0.5 * this.chart.width >> 0 : this.options.labelMaxWidth, this.chart.panEnabled || (l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize);
            else if ("left" === this._position || "right" === this._position) h = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.height * Math.log(Math.min(this._labels[this._labels.length - 1].position /
            ...
            if (this.labelAutoFit || this.options.labelAutoFit)
                if (r(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)
                    if (f = 0.9 * h >> 0, q = 0, !this.chart.panEnabled && 1 <=
                        this._labels.length) {
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                for (var w, g = a.text.split(" "), b = 0; b < g.length; b++) n = g[b], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, n = this.ctx.measureText(n),
                                    n.width > q && (w = c, q = n.width)
                            }
                        c = 0;
                                ...
                                if (r(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), n = (k - (m + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !r(this.options.labelWrap)) this.labelWrap ? r(this.options.labelMaxWidth) ?
                                        ...
                                        if (r(this.options.labelWrap))
                                            if (!r(this.options.labelMaxWidth)) this.options.labelMaxWidth < f ?
                                                (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = l);
                                            else if (!r(d))
                                            if (b = t.width + d.width >> 0, g = this.labelFontSize, q < f) b - 2 * f > p && (p = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, r(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ?
            ...
            for (c = 0; c < this.stripLines.length; c++) {
                ...
                if ("outside" === f.labelPlacement) {
                    ...
                    if ("bottom" === this._position || "top" === this._position) r(f.options.labelWrap) && !r(this.sessionVariables.stripLineLabelMaxHeight) ? E = this.sessionVariables.stripLineLabelMaxHeight : this.sessionVariables.stripLineLabelMaxHeight = E = f.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                    if ("left" === this._position || "right" === this._position) r(f.options.labelWrap) && !r(this.sessionVariables.stripLineLabelMaxHeight) ? E = this.sessionVariables.stripLineLabelMaxHeight : this.sessionVariables.stripLineLabelMaxHeight = E = f.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
                    r(f.labelBackgroundColor) && (f.labelBackgroundColor = "#EEEEEE")
                } else l = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0, E = r(f.options.labelWrap) || f.labelWrap ? "bottom" === this._position ||
                    "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize, r(f.labelBackgroundColor) && (r(f.startValue) && 0 !== f.startValue ? f.labelBackgroundColor = v ? "transparent" : null : f.labelBackgroundColor = "#EEEEEE");
                a = new ka(this.ctx, {
                    x: 0,
                    y: 0,
        ...
        E.setLayout = function(a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks &&
                    ...
                    for (var t = q[g].scaleBreaks._appliedBreaks, v = 0; v < t.length && !(t[v].startValue > q[g].viewportMaximum); v++) t[v].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = v), t[v].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = v));
            for (var w = v = 0, u = 0, y = 0, x = 0, B = 0, D = 0, z, E, A = h = 0, F, I, J, t = F = I = J = !1, g = 0; g < q.length; g++) q[g] && q[g].title && (q[g]._titleTextBlock = new ka(q[g].ctx, {
                text: q[g].title,
                horizontalAlign: "center",
            ...
            if ("normal" === e) {
                for (var y = [], x = [], B = [], D = [], K = [], N = [], O = [], P = []; 4 >
                    ...
                    var G = 0,
                        ...
                        $ = 0;
                    if (c && 0 < c.length)
                        for (B = [], g = R = 0; g < c.length; g++) B.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), R += B[g], M += c[g] && !n.isNavigator ? c[g].margin : 0;
                    ...
                    if (a && 0 < a.length)
                        for (g =
                            ...
                            h, a[g].lineCoordinates.y2 = h + a[g].lineThickness / 2, "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.y1 = a[g].lineCoordinates.y1 + y[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0) - ("inside" === a[g].tickPlacement ? a[g].tickLength : 0), a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2), a[g].bounds = {
                                x1: l,
                                y1: h,
                                x2: m,
                                y2: k - (W + e - y[g] - G),
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) d[g].lineCoordinates.x1 = Math.round(f.x1 + R + M), d[g].lineCoordinates.x2 =
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), m = Math.round(l), M = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(f.y1 + Y + V < Math.max(M, p) ? Math.max(M, p) : f.y1 + Y + V), M = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 - (W + e + M)), b[g].lineCoordinates = {
                            x1: l + X,
                            y1: h,
                            x2: l + X,
                            y2: k,
                            height: Math.abs(k - h)
                        }, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (D[g] - (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2, b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2), b[g].bounds = {
                            x1: l,
                            y1: h,
                            x2: m + (D[g] + X),
                            y2: k,
                    ...
                    if (0 < v) {
                        if (a && 0 < a.length)
                            for (g = 0; g < a.length; g++) t = K[v - 1][g] === K[v][g] ? !0 : !1;
                        else t = !0;
                        if (d && 0 < d.length)
                            for (g = 0; g < d.length; g++) F = N[v - 1][g] === N[v][g] ? !0 : !1;
                        else F = !0;
                        if (c && 0 < c.length)
                            for (g = 0; g < c.length; g++) I = O[v - 1][g] === O[v][g] ? !0 : !1;
                        else I = !0;
                        if (b && 0 < b.length)
                            for (g = 0; g < b.length; g++) J = P[v -
                                1][g] === P[v][g] ? !0 : !1;
                        else J = !0
                    }
                    if (t && F && I && J) break;
                ...
                K = [];
                for (N = []; 4 > v;) {
                    W = X = Q = U = Z = M = V = e = P = O = G = Y = 0;
                    if (a && 0 < a.length)
                        for (A = [], g = X = 0; g < a.length; g++) A.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), X += A[g], e += a[g] && !n.isNavigator ? a[g].margin : 0;
                    else A.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    K.push(A);
                    if (d && 0 < d.length)
                        for (w = [], g = W = 0; g < d.length; g++) w.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), W += w[g], V += d[g] ? d[g].margin : 0;
                    else w.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() :
                        0));
                    N.push(w);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) c[g].lineCoordinates = {}, l = Math.round(f.x1 + X + e), m = Math.round(f.x2 - W - V > n.width - 10 ? n.width - 10 : f.x2 - W - V), c[g].labelAutoFit && !r(y) && (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, y) : 0 === c[g].labelAngle ? Math.max(l, y / 2) : l), 0 < !d.length && (m = 0 < c[g].labelAngle ? m - x / 2 : 0 === c[g].labelAngle ? m - x / 2 : m)), c[g].lineCoordinates.x1 = l, c[g].lineCoordinates.x2 = m, c[g].lineCoordinates.width = Math.abs(m - l), c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth <
                            c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width);
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g].lineCoordinates = {}, l = Math.round(f.x1 + X + e), m = Math.round(f.x2 - W - V > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - W - V), b[g] && b[g].labelAutoFit && !r(B) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, B) : 0 === b[g].labelAngle ? Math.max(l, B / 2) : l), 0 < !d.length && (m -= D / 2)), b[g].lineCoordinates.x1 = l, b[g].lineCoordinates.x2 = m, b[g].lineCoordinates.width = Math.abs(m - l), b[g].title && (b[g]._titleTextBlock.maxWidth =
                            0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width);
                    if (c && 0 < c.length)
                        for (p = [], g = U = 0; g < c.length; g++) p.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), U += p[g] + c[g].margin, M += c[g].margin;
                    else p.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                    E.push(p);
                    if (b && 0 < b.length)
                        for (z = [], g = Q = 0; g < b.length; g++) z.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), Q += z[g], Z += b[g].margin;
                    ...
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--) b[g] && (h = Math.round(f.y1), k = Math.round(f.y1 + (z[g] + b[g].margin + G)), b[g].lineCoordinates.y1 =
                            k, b[g].lineCoordinates.y2 = k, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = k - z[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = {
                                x1: l,
                                y1: h + (b[g].margin + G),
                                x2: m,
                                y2: k,
                                width: m - l,
                                height: Q
                            }, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width), G += z[g] + b[g].margin);
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) {
                            ...
                            k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > n.height - Math.max(M, 10) ? n.height - Math.max(M, 10) : f.y2 - U) : f.y2 > n.height - Math.max(M, 10) ? n.height - Math.max(M, 10) : f.y2;
                            if (c && 0 < c.length)
                                for (M = 0; M < c.length; M++) c[M] && c[M].labelAutoFit && (m = 0 > c[M].labelAngle ? Math.max(m, y) : 0 === c[M].labelAngle ? Math.max(m, y / 2) : m, l =
                            ...
                            "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.x1 = a[g].lineCoordinates.x1 - (A[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0)) + ("outside" === a[g].tickPlacement ? a[g].tickLength : 0), a[g].lineCoordinates.x2 = a[g].lineCoordinates.x1 + a[g].lineThickness / 2);
                            a[g].bounds = {
                                x1: m - (A[g] +
                                    O),
                                y1: h,
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            ...
                            m = Math.round(f.x2 - W - V);
                            k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > n.height - Math.max(M, 10) ? n.height - Math.max(M, 10) : f.y2 - U) : f.y2 > n.height - Math.max(M, 10) ? n.height - Math.max(M, 10) : f.y2;
                            if (c && 0 < c.length)
                                for (M = 0; M < c.length; M++) c[M] && c[M].labelAutoFit && (m = 0 > c[M].labelAngle ? Math.max(m, y) : 0 === c[M].labelAngle ? Math.max(m, y / 2) : m, l = 0 > c[M].labelAngle || 0 === c[M].labelAngle ? m - W : l);
                            if (b && 0 < b.length)
                                for (M = 0; M < b.length; M++) b[M] &&
                                    b[M].labelAutoFit && (m = b[M].lineCoordinates.x2, l = m - W);
                            d[g].lineCoordinates = {
                                x1: m + P,
                                y1: h,
                                x2: m + P,
                    ...
                    if (0 < v) {
                        ...
                        if (d && 0 < d.length)
                            for (g = 0; g < d.length; g++) F = N[v - 1][g] === N[v][g] ? !0 :
                                !1;
                        else F = !0;
                        if (c && 0 < c.length)
                            for (g = 0; g < c.length; g++) I = E[v - 1][g] === E[v][g] ? !0 : !1;
                        else I = !0;
                        if (b && 0 < b.length)
                            for (g = 0; g < b.length; g++) J = u[v - 1][g] === u[v][g] ? !0 : !1;
                        else J = !0
                    }
                    if (t && F && I && J) break;
                    v++
        ...
        E.render = function(a, d, c, b, e) {
            ...
            if (d && 0 < d.length)
                for (l = 0; l < d.length; l++) d[l].renderGrid(), v && (d[l].createMask(), d[l].renderBreaksBackground());
            if (c && 0 < c.length)
                for (l = 0; l < c.length; l++) c[l].renderGrid(), v && (c[l].createMask(), c[l].renderBreaksBackground());
            if (b && 0 < b.length)
                for (l = 0; l < b.length; l++) b[l].renderGrid(), v && (b[l].createMask(), b[l].renderBreaksBackground());
            if (a && 0 < a.length)
                ...
                if ("axisX" === this.type && c) {
                    ...
                    this.intervalType || (b / 1 <= a ? (this.interval = 1, this.intervalType = "millisecond") : b / 2 <= a ? (this.interval = 2, this.intervalType = "millisecond") : b / 5 <= a ? (this.interval = 5, this.intervalType = "millisecond") : b / 10 <= a ? (this.interval = 10, this.intervalType = "millisecond") : b / 20 <= a ? (this.interval = 20, this.intervalType = "millisecond") : b / 50 <= a ? (this.interval = 50, this.intervalType = "millisecond") : b / 100 <= a ? (this.interval = 100, this.intervalType = "millisecond") : b / 200 <= a ? (this.interval = 200, this.intervalType = "millisecond") :
                        b / 250 <= a ? (this.interval = 250, this.intervalType = "millisecond") : b / 300 <= a ? (this.interval = 300, this.intervalType = "millisecond") : b / 400 <= a ? (this.interval = 400, this.intervalType = "millisecond") : b / 500 <= a ? (this.interval = 500, this.intervalType = "millisecond") : b / (1 * K.secondDuration) <= a ? (this.interval = 1, this.intervalType = "second") : b / (2 * K.secondDuration) <= a ? (this.interval = 2, this.intervalType = "second") : b / (5 * K.secondDuration) <= a ? (this.interval = 5, this.intervalType = "second") : b / (10 * K.secondDuration) <= a ? (this.interval = 10,
                            ...
                            2, this.intervalType = "month") : b / (3 * K.monthDuration) <= a ? (this.interval = 3, this.intervalType = "month") : b / (6 * K.monthDuration) <= a ? (this.interval = 6, this.intervalType = "month") : (this.interval = b / (1 * K.yearDuration) <= a ? 1 : b / (2 * K.yearDuration) <= a ? 2 : b / (4 * K.yearDuration) <= a ? 4 : Math.floor(E.getNiceNumber(b / (a - 1), !0) / K.yearDuration), this.intervalType = "year"));
        ...
        E.prototype.calculateLogarithmicAxisParameters =
            function() {
                var a = this.chart.layoutManager.getFreeSpace(),
                ...
                if (this.scaleBreaks)
                    for (l = 0; l < this.scaleBreaks._appliedBreaks.length; l++)
                        if ((!r(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[l].startValue || !r(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[l].startValue || !r(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[l].startValue) && (!r(this.sessionVariables.newViewportMaximum) &&
                                this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[l].endValue || !r(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[l].endValue || !r(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[l].endValue)) {
                ...
                this.intervalType = "number";
                l = Math.pow(this.logarithmBase, E.getNiceNumber(Math.abs(Math.log(l) / d), !1));
                this.options && 0 < this.options.interval ? this.interval = this.options.interval : (this.interval = E.getNiceExponent(Math.log(l) / d / (a - 1), !0), c = E.getNiceNumber(h / (a - 1), !0));
                ...
                1 === this.viewportMaximum && 1 === this.viewportMinimum && (1 === this.options.viewportMinimum ? this.viewportMaximum *= this.logarithmBase - 1 / this.logarithmBase : 1 === this.options.viewportMaximum && (this.viewportMinimum /= this.logarithmBase - 1 / this.logarithmBase), this.options && "undefined" === typeof this.options.interval &&
                    (this.interval = E.getNiceExponent(Math.ceil(Math.log(l) / d) / (a - 1)), c = E.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)));
        ...
        Q.prototype.render = function() {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, h = this.chart.plotArea.y1, m = this.chart.plotArea.y2, this.bounds = {
                    x1: e - d / 2,
                    y1: h,
                    x2: f + d / 2,
                    y2: m
        ...
        ca.prototype.render = function(a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    for (var A = 0; A < this.parent.dataSeries.length; A++)(w = this.parent.dataSeries[A].getDataPointAtX(t, !0)) && 0 <= w.index && (w.dataSeries = this.parent.dataSeries[A], null !== w.dataPoint.y && w.dataSeries.visible &&
                        n.push(w));
                    w = null;
                    ...
                    if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type)
                        for (var w = Math.abs(a - this.parent.convertValueToPixel(n[A].dataPoint.y[0])), u = 0, t = 0; t < n.length; t++)
                            if (n[t].dataPoint.y && n[t].dataPoint.y.length)
                                for (var y = 0; y < n[t].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t);
                            else u =
                                Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y)), u < w && (w = u, A = t);
                    else if ("stackedBar" === n[0].dataSeries.type)
                        for (var w = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), x = u = 0, t = A = 0; t < n.length; t++)
                            if (n[t].dataPoint.y && n[t].dataPoint.y.length)
                                for (y = 0; y < n[t].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t);
                            else x += n[t].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(x)), u < w && (w = u, A = t);
                    else if ("stackedBar100" === n[0].dataSeries.type)
                        for (var w =
                                Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), B = x = u = 0, t = 0; t < n.length; t++)
                            if (n[t].dataPoint.y && n[t].dataPoint.y.length)
                                for (y = 0; y < n[t].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t);
                            else x += n[t].dataPoint.y, B = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x, B = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[B]), u = Math.abs(a - this.parent.convertValueToPixel(B)), u < w && (w = u, A = t);
                    else
                        for (w = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)),
                            t = A = u = 0; t < n.length; t++)
                            if (n[t].dataPoint.y && n[t].dataPoint.y.length)
                                for (y = 0; y < n[t].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t);
                            else u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y)), u < w && (w = u, A = t);
                    y = n[A];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        b = 0;
                        if ("rangeBar" === this.parent.dataSeries[A].type || "error" === this.parent.dataSeries[A].type) {
                            w = Math.abs(a - this.parent.convertValueToPixel(y.dataPoint.y[0]));
                            for (t = u = 0; t < y.dataPoint.y.length; t++) u = Math.abs(a - this.parent.convertValueToPixel(y.dataPoint.y[t])), u < w && (w = u, b = t);
                            ...
                            k.text = this.labelFormatter ? this.labelFormatter({
                                ...
                                }) : r(this.options.label) ? ha(r(c) ? y.dataPoint.y[b] : c, this.valueFormatString, this.chart._cultureInfo) :
                                this.label
                        } else if ("stackedBar" === this.parent.dataSeries[A].type) {
                            w = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y));
                            x = u = 0;
                            for (t = A; 0 <= t; t--) x += n[t].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(x)), u < w && (w = u, b = t);
                            ...
                            k.text = this.labelFormatter ? this.labelFormatter({
                                ...
                                ha(r(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else if ("stackedBar100" === this.parent.dataSeries[A].type) {
                            w = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y));
                            B = x = u = 0;
                            for (t = A; 0 <= t; t--) x += n[t].dataPoint.y, B = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x, B = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[B]), u = Math.abs(a - this.parent.convertValueToPixel(B)), u < w && (w = u, b = t);
                            m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(B) << 0) + 0.5 :
                            ...
                            k.text = this.labelFormatter ? this.labelFormatter({
                                ...
                                crosshair: this.options,
                                value: B
                            }) : r(this.options.label) ? ha(r(c) ? B : c, this.valueFormatString, this.chart._cultureInfo) : this.label
                            ...
                            crosshair: this.options,
                            value: y.dataPoint.y
                        }) : r(this.options.label) ? ha(r(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        b = e = m;
                        ...
                        f = h = v = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.x) << 0;
                        ...
                        if (this.parent.labels)
                            for (n = Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t +=
                                n)
                                if (this.parent.labels[t]) B = !0;
                                else {
                                    B = !1;
                                    break
                                }
                        if (B) {
                            if ("axisX" === this.parent.type)
                                for (t = this.parent.convertPixelToValue({
                                        y: d
                                    }), w = null, A = 0; A < this.parent.dataSeries.length; A++)(w = this.parent.dataSeries[A].getDataPointAtX(t, !0)) && 0 <= w.index && (k.text = this.labelFormatter ? this.labelFormatter({
                                    chart: this.chart,
                                    axis: this.parent.options,
                                    crosshair: this.options,
                                    value: y.dataPoint.x
                                }) : r(this.options.label) ? w.dataPoint.label : this.label)
                        } else "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: y.dataPoint.x
                        }) : r(this.options.label) ? Ba(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: y.dataPoint.x
                        }) : r(this.options.label) ? ha(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    for (A = 0; A < this.parent.dataSeries.length; A++)(w =
                        this.parent.dataSeries[A].getDataPointAtX(t, !0)) && 0 <= w.index && (w.dataSeries = this.parent.dataSeries[A], null !== w.dataPoint.y && w.dataSeries.visible && n.push(w));
                    if (0 === n.length) return;
                    n.sort(function(a, b) {
                        return a.distance - b.distance
                    });
                    ...
                    if (this.parent.labels)
                        for (n = Math.ceil(this.parent.interval),
                            t = 0; t < this.parent.viewportMaximum; t += n)
                            if (this.parent.labels[t]) B = !0;
                            else {
                                B = !1;
                                break
                    ...
                    !r(this.parent.dataSeries) && 0 < this.parent.dataSeries.length && (t = this.parent.dataSeries[0].axisX.convertPixelToValue({
                        x: a
                    }));
                    for (A = 0; A < this.parent.dataSeries.length; A++)(w = this.parent.dataSeries[A].getDataPointAtX(t, !0)) && 0 <= w.index && (w.dataSeries = this.parent.dataSeries[A], null !== w.dataPoint.y && w.dataSeries.visible && n.push(w));
                    if (0 === n.length) return;
                    n.sort(function(a, b) {
                        return a.distance - b.distance
                    });
                    ...
                    if ("rangeColumn" === n[0].dataSeries.type || "rangeArea" === n[0].dataSeries.type || "error" === n[0].dataSeries.type || "rangeSplineArea" === n[0].dataSeries.type || "candlestick" === n[0].dataSeries.type || "ohlc" === n[0].dataSeries.type ||
                        ...
                        for (w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])), t = u = 0; t < n.length; t++)
                            if (n[t].dataPoint.y && n[t].dataPoint.y.length)
                                for (y = 0; y < n[t].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t);
                            else u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y)), u < w && (w = u, A = t);
                        ...
                        for (w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)),
                            t = x = u = 0; t < n.length; t++)
                            if (n[t].dataPoint.y && n[t].dataPoint.y.length)
                                for (y = 0; y < n[t].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t);
                            else x += n[t].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(x)), u < w && (w = u, A = t);
                    else if ("stackedColumn100" === n[0].dataSeries.type || "stackedArea100" === n[0].dataSeries.type)
                        for (w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), t = B = x = u = 0; t < n.length; t++)
                            if (n[t].dataPoint.y && n[t].dataPoint.y.length)
                                for (y =
                                    0; y < n[t].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t);
                            else x += n[t].dataPoint.y, B = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x, B = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[B]), u = Math.abs(d - this.parent.convertValueToPixel(B)), u < w && (w = u, A = t);
                    else
                        for (w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), t = u = 0; t < n.length; t++)
                            if (n[t].dataPoint.y && n[t].dataPoint.y.length)
                                for (y = 0; y < n[t].dataPoint.y.length; y++) u =
                                    Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t);
                            else u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y)), u < w && (w = u, A = t);
                    y = n[A];
                    b = 0;
                    if ("rangeColumn" === this.parent.dataSeries[A].type || "rangeArea" === this.parent.dataSeries[A].type || "error" === this.parent.dataSeries[A].type || "rangeSplineArea" === this.parent.dataSeries[A].type || "candlestick" === this.parent.dataSeries[A].type || "ohlc" === this.parent.dataSeries[A].type || "boxAndWhisker" === this.parent.dataSeries[A].type) {
                        w =
                            Math.abs(d - this.parent.convertValueToPixel(y.dataPoint.y[0]));
                        for (t = u = 0; t < y.dataPoint.y.length; t++) u = Math.abs(d - this.parent.convertValueToPixel(y.dataPoint.y[t])), u < w && (w = u, b = t);
                        v = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.y[b]) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.y[b]) << 0;
                        k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: y.dataPoint.y[b]
                        }) : r(this.options.label) ? ha(r(c) ? y.dataPoint.y[b] : c, this.valueFormatString,
                            this.chart._cultureInfo) : this.label;
                        this.value = y.dataPoint.y[b]
                    } else if ("stackedColumn" === this.parent.dataSeries[A].type || "stackedArea" === this.parent.dataSeries[A].type) {
                        w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y));
                        x = u = 0;
                        for (t = A; 0 <= t; t--) x += n[t].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(x)), u < w && (w = u, b = t);
                        v = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x) << 0) + 0.5 : this.parent.convertValueToPixel(x) << 0;
                        k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                        ...
                        this.value = x
                    } else if ("stackedColumn100" === this.parent.dataSeries[A].type || "stackedArea100" === this.parent.dataSeries[A].type) {
                        w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y));
                        x = u = 0;
                        for (t = A; 0 <= t; t--) x += n[t].dataPoint.y, B = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x, B = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[B]),
                            u = Math.abs(d - this.parent.convertValueToPixel(B)), u < w && (w = u, b = t);
                        v = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(B) << 0) + 0.5 : this.parent.convertValueToPixel(B) << 0;
                        k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                        ...
                        this.value = B
                    } else "waterfall" === this.parent.dataSeries[A].type ? (v = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum) <<
                    ...
                    }) : r(this.options.label) ? ha(r(c) ? y.dataSeries.dataPointEOs[y.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = y.dataSeries.dataPointEOs[y.index].cumulativeSum) : (v = 1 === q.lineWidth % 2 ? (r(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) <<
                        0) + 0.5 : r(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0, k.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: r(c) ? y.dataPoint.y : c
                    }) : r(this.options.label) ? ha(r(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = y.dataPoint.y);
                    f = h = v;
                    b = this.chart.plotArea.x1;
                    e = this.chart.plotArea.x2;
                    this.bounds = {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = m = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, h = this.chart.plotArea.y2, this.bounds = {
                    x1: b - p / 2,
                    y1: f,
                    x2: e + p / 2,
                    y2: h
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" ===
                        ...
                        B = !1;
                        if (this.parent.labels)
                            for (n = Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t += n)
                                if (this.parent.labels[t]) B = !0;
                                else {
                                    B = !1;
                                    break
                        ...
                        }) : r(this.options.label) ? Ba(r(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: r(c) ? this.parent.convertPixelToValue(d) : c
                        }) : r(this.options.label) ? ha(r(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label);
                        ...
                        if ("bottom" === this.parent._position || "top" === this.parent._position) k.text = this.labelFormatter ? this.labelFormatter({
                                ...
                                crosshair: this.options,
                                value: r(c) ? this.parent.convertPixelToValue(a) : c
                            }) : r(this.options.label) ? ha(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label, k.x = b - k.measureText().width /
                    ...
                    if (B) {
                        if ("axisX" === this.parent.type)
                            for (t = this.parent.convertPixelToValue({
                                ...
                                crosshair: this.options,
                                value: r(c) ? this.parent.convertPixelToValue(a) : c
                            }) : r(this.options.label) ? r(c) ? w.dataPoint.label : c : this.label)
                        ...
                        this.labelFormatter({
                            ...
                            crosshair: this.options,
                            value: r(c) ? this.parent.convertPixelToValue(a) : c
                        }) : r(this.options.label) ? Ba(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: r(c) ? 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : "" : c
                            }) : r(this.options.label) ?
                            ha(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    k.x = b - k.measureText().width / 2;
                    k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width);
                    k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1);
                    "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2)
                    ...
                    this.labelFormatter ? this.labelFormatter({
                        ...
                        crosshair: this.options,
                        value: r(c) ? this.parent.convertPixelToValue(d) : c
                    }) : r(this.options.label) ? ha(r(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label, k.y = d + k.fontSize / 2 - k.measureText().height / 2 + 2, k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height - k.fontSize / 2 > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.measureText().height +
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    ...
                    if (this.chart.axisX)
                        for (var w = 0; w < this.chart.axisX.length; w++) {
                            for (var h = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX[w].convertPixelToValue({
                                    y: d
                                }) : this.chart.axisX[w].convertPixelToValue({
                                    x: a
                                }), k = null, b = 0; b < this.chart.axisX[w].dataSeries.length; b++)(k = this.chart.axisX[w].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[w].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && m.push(k));
                            k = null
                        }
                    if (this.chart.axisX2)
                        for (w = 0; w < this.chart.axisX2.length; w++) {
                            h =
                                "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX2[w].convertPixelToValue({
                                    y: d
                                }) : this.chart.axisX2[w].convertPixelToValue({
                                    x: a
                                });
                            k = null;
                            for (b = 0; b < this.chart.axisX2[w].dataSeries.length; b++)(k = this.chart.axisX2[w].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[w].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && m.push(k));
                            k = null
                        }
                ...
                if (0 < f.length) {
                    if (this.highlightObjects(f), this.enabled) {
                        c = "";
                        c = this.getToolTipInne.php({
                            entries: f
                        });
                        if (null !== c) {
                            this.contentDiv.inne.php = c;
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    ...
                    !1 === f.highlightEnabled || !0 !== b.highlightEnabled && !0 !== f.highlightEnabled || ("line" === b.type || "stepLine" === b.type ||
                        ...
                        "rangeColumn" === b.type || "waterfall" === b.type ? da(d, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === b.type || "doughnut" === b.type ? ra(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "funnel" === b.type || "pyramid" === b.type ? ta(d, e.funnelSection, 0.3, "white") : "candlestick" === b.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, b = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - b, Math.min(e.y2, e.y3)), d.lineTo(e.x3 - b, Math.min(e.y1, e.y4)),
                            ...
                            e.lineColor, d.lineWidth = 2 * e.lineThickness, 0 < e.lineThickness && (d.beginPath(), d.moveTo(e.x1, e.y5), d.lineTo(e.x2, e.y5), d.stroke()), d.restore(), d.globalAlpha = 1) : "error" === b.type && A(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3))
                }
            }
            d.restore();
            d.globalAlpha = 1;
        ...
        $.prototype.getToolTipInne.php = function(a) {
            a = a.entries;
            var d = null,
                c = null,
                b = null,
        ...
        $.prototype.showAtX = function(a, d) {
            ...
            if (0 < f.length) {
                ...
                this._entries = f;
                h = "";
                h = this.getToolTipInne.php({
                    entries: f
                });
                if (null !== h) {
                    this.contentDiv.inne.php = h;
                    ...
                    try {
                        this.contentDiv.style.background = this.backgroundColor ? this.backgroundColor : v ? "rgba(255,255,255,.9)" : "rgb(255,255,255)", this.borderColor = "waterfall" === f[0].dataSeries.type ? this.contentDiv.style.borderRightColor = this.contentDiv.style.borderLeftColor =
            ...
            ba = {
                drawMarker: function(a, d, c, b, e, f, h, m) {
                    if (c) {
                        ...
                        c.lineWidth = m ? m : 0;
                        c.setLineDash && c.setLineDash(I("solid", m));
...
/*
  excanvas is used to support IE678 which do not implement.php5 Canvas Element. You can safely remove the following excanvas code if you don't need to support older browsers.
...
document.createElement("canvas").getContext || function() {
    ...
    d.drawImage = function(a, b) {
        ...
        this.element_.insertAdjacen.php("BeforeEnd", p.join(""))
    };
    d.stroke = function(a) {
        var b = [];
        ...
        b.push("</g_vml_:shape>");
        this.element_.insertAdjacen.php("beforeEnd", b.join(""))
    };
    d.fill = function() {
        this.stroke(!0)
    };
    ...
    d.drawText_ = function(a, b, c, d, e) {
        ...
        this.element_.insertAdjacen.php("beforeEnd", n.join(""))
    };
    ...
    d.measureText = function(a) {
        this.textMeasureEl_ || (this.element_.insertAdjacen.php("beforeEnd", '<span style="position:absolute;top:-20000px;left:0;padding:0;margin:0;border:none;white-space:pre;"></span>'), this.textMeasureEl_ = this.element_.lastChild);
        var b = this.element_.ownerDocument;
        this.textMeasureEl_.inne.php = "";
