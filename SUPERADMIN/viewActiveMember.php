...
$count = 0;
$queryActive = mysqli_query($con, 'SELECT user_id,name,phone,sponser_id,date_time,password,activation_date from sub_admin_user_details WHERE member_id!=1 AND topup_flag=1 '.$query.' ORDER BY activation_date DESC');
while ($valActive = mysqli_fetch_assoc($queryActive)) {
    ++$count; ?>
                  <tr>
                    ...
                    <td><?php echo $valActive['activation_date']; ?></td>
