...
if ($valMail = mysqli_fetch_array($queryMail)) {
    ...
    $queryupdate = mysqli_query($con, "UPDATE sub_admin_user_details SET password='$encLogPass' WHERE member_id='$member_id'");

    require_once '../PHPMailer/PHPMailer.php';
    require_once '../PHPMailer/SMTP.php';
    require_once '../PHPMailer/Exception.php';
    require_once '../PHPMailer/OAuthCredential.php';
    $mailSubject = 'HELP LEDGE Account Details';
    $mailSubject = 'HELP LEDGE Password Recover';
    $newMsg = '<html>
                    <head>
                        <title>HELP LEDGE Password Recover</title>
                    ...
                    <br />
                    <span style="background-color:#ffffff; color:#222222; font-family:arial,helvetica,sans-serif; font-size:small"><em><strong><span style="font-size:14px">HELP LEDGE</span></strong></em> has registered a account on your name. Below are its access details<br /><br />
