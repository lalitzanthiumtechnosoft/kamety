        ...
        <div class="iq-card-body">
          <form>
            <div class="form-row">
              ...
              <div class="col-3">
                <input type="text" name="to_date" id="to_date" class="form-control " placeholder="e.g. To Date"
                  required="" value="<?php echo $show_date1; ?>" readonly>
              </div>
              <div class="col-2">
...
$count = 0;
$query = 'SELECT * from user_royalty_income_details where 1=1 '.$query.' order by date_time desc';
$result = mysqli_query($con, $query);
while ($val1 = mysqli_fetch_array($result)) {
    ++$count; ?>
                  <tr>
                    <td><?php echo $count; ?></td>
                    <td><?php echo name($con, $val1['sender_member_id']); ?> ( <?php echo user_id($con, $val1['sender_member_id']); ?> )
                    </td>
                    <td><?php echo name($con, $val1['receiver_member_id']); ?> ( <?php echo user_id($con, $val1['receiver_member_id']); ?>
                      )
                    </td>
