       ...
       <div class="iq-card">
          <div class="iq-card-header d-flex justify-content-between">
             <div class="iq-header-title">
                <h4 class="card-title">Online Payment Status</h4>
             </div>
          </div>
          <div class="iq-card-body">
             <div class="table-responsive">
                <table id="example" class="table table-striped table-bordered">
                   ...
                   <tbody>
                    <?php
                    $count = 0;
$queryInvest = mysqli_query($con, "SELECT a.packagePrice,a.addDate,a.orderId,a.priceAmount,a.payAmount,a.payCurrency,a.payAddress,a.paymentStatus,b.user_id,b.name FROM user_invest_purchase_details a, sub_admin_user_details b WHERE CAST(a.addDate AS DATE) BETWEEN '$cal_date' AND '$cal_date1' AND a.memberId=b.member_id order by a.addDate DESC");
while ($valInvest = mysqli_fetch_assoc($queryInvest)) {
    ...
    ++$count; ?>
                      <tr>
                        ...
                        <td><i class="fa fa-usd"></i> <?php echo $valInvest['packagePrice']; ?></td>
...
var d = document.getElementById("member");
    d.className += " active";
var d = document.getElementById("paymentHistory");
    d.className += " active";
</script>
</body>
</html>