...
<head>
  ...
  <title>HELP LEDGE | Admin Login </title>
  <!-- Favicon -->
  <link rel="shortcut icon" href="../images/logo-xpert-fav.png" />
  <!-- Bootstrap CSS -->
                        ...
                        <div class="sign-in-from">
                            ...
                            <form class="mt-4" action="login-process" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-0" id="exampleInputEmail1" name="username" placeholder="Username" required autofocus >
                                </div>
                                <div class="form-group">
