         ...
         <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
               <div class="iq-header-title">
                  <h4 class="card-title">Royalty Transfer</h4>
               </div>
            </div>
            <div class="iq-card-body">
               <form class="text-center" method="POST" action="royaltyTransferBack" onsubmit="return confirm('Are you sure?')" >
                  <fieldset>
                     <div class="form-card text-left">
                        <div class="row">
                           <div class="col-12">
                              <h3 class="mb-4">Royalty Transfer</h3>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-md-12">
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 <label>Royalty Amount Transfer -:</label>
                     ...
                     <button type="submit" name="royaltyTransfer" class="btn btn-primary action-button float-left" value="Submit" >Transfer Now</button>
