...
$count = 0;
$queryUser = mysqli_query($con, "SELECT * from sub_admin_user_details WHERE member_id!=1 AND user_type=2 AND (goldId=1 OR goldId=0) AND packageType=2 AND CAST(date_time AS DATE) BETWEEN '$cal_date' AND '$cal_date1' ".$query.' order by date_time desc');
