       ...
       <div class="iq-card">
          <div class="iq-card-header d-flex justify-content-between">
             <div class="iq-header-title">
                <h4 class="card-title">Wallet Withdraw</h4>
             </div>
          </div>
          <div class="iq-card-body">
...
while ($valWithdraw = mysqli_fetch_array($queryWithdraw)) {
    ++$count; ?>
                    <tr>
                        ...
                        <td class="text-danger font-weight-bold"> <?php echo $valWithdraw['amount']; ?></td>
                        <td class="text-primary font-weight-bold"> <?php echo $valWithdraw['withdrawCharge']; ?></td>
                        <td class="text-success font-weight-bold"> <?php echo $valWithdraw['netAmount']; ?></td>
...
var d = document.getElementById("payout");
    d.className += " active";
var d = document.getElementById("walletWithdrawCheck");
    d.className += " active";
</script>
</body>
</html>